...
test( 'zgemm: basic N,N (M=2, N=2, K=2)', function t() {
	...
	var A = new Float64Array( [ 1, 1, 2, 0, 3, 0, 4, 1 ] );
	...
	var beta = new Float64Array( [ 0, 0 ] );
	var result = base( 'N', 'N', 2, 2, 2, alpha, A, 1, 2, 0, B, 1, 2, 0, beta, C, 1, 2, 0 );
	assert.strictEqual( result, C );
	assertArrayClose( Array.from( C ), tc.c, 'zgemm_basic_nn c' );
});
...
test( 'zgemm: conjugate transpose A (C=A^H*B)', function t() {
	...
	var B = new Float64Array( [ 1, 0, 0, 1, 1, 1, 2, 0 ] );
	var C = new Float64Array( 8 );
	var alpha = new Float64Array( [ 1, 0 ] );
	var beta = new Float64Array( [ 0, 0 ] );
	var result = base( 'C', 'N', 2, 2, 2, alpha, A, 1, 2, 0, B, 1, 2, 0, beta, C, 1, 2, 0 );
	assert.strictEqual( result, C );
	assertArrayClose( Array.from( C ), tc.c, 'zgemm_conjA c' );
});
...
test( 'zgemm: alpha and beta scaling', function t() {
	...
	var B = new Float64Array( [ 2, 1, 0, 0, 0, 0, 3, 2 ] );
	var C = new Float64Array( [ 1, 1, 0, 0, 0, 0, 1, 1 ] );
	var alpha = new Float64Array( [ 2, 1 ] );
	var beta = new Float64Array( [ 1, -1 ] );
	var result = base( 'N', 'N', 2, 2, 2, alpha, A, 1, 2, 0, B, 1, 2, 0, beta, C, 1, 2, 0 );
	assert.strictEqual( result, C );
	assertArrayClose( Array.from( C ), tc.c, 'zgemm_alpha_beta c' );
});
...
test( 'zgemm: transpose A, no transpose B (C=A^T*B)', function t() {
	...
	assert.strictEqual( result, C );
	assertArrayClose( Array.from( C ), tc.c, 'zgemm_transA_N c' );
});
...
test( 'zgemm: alpha=0, beta=0 (C should be zeroed)', function t() {
	...
	var A = new Float64Array( [ 1, 1, 2, 0, 0, 0, 0, 0 ] );
	var B = new Float64Array( [ 1, 0, 0, 1, 0, 0, 0, 0 ] );
	var C = new Float64Array( [ 5, 3, 7, 2, 1, 1, 9, 4 ] );
	var alpha = new Float64Array( [ 0, 0 ] );
	var beta = new Float64Array( [ 0, 0 ] );
	var result = base( 'N', 'N', 2, 2, 2, alpha, A, 1, 2, 0, B, 1, 2, 0, beta, C, 1, 2, 0 );
	assert.strictEqual( result, C );
	assertArrayClose( Array.from( C ), tc.c, 'zgemm_alpha_zero_beta_zero c' );
});
...
test( 'zgemm: conjugate A, conjugate B (C=A^H*B^H)', function t() {
	...
	assert.strictEqual( result, C );
	assertArrayClose( Array.from( C ), tc.c, 'zgemm_conjA_conjB c' );
});

test( 'zgemm: transpose A, transpose B (C=A^T*B^T)', function t() {
	var tc = fixture.find( function( t ) { return t.name === 'zgemm_transA_transB'; } );
	var A = new Float64Array( [ 1, 1, 2, 0, 3, 1, 4, 2 ] );
	var B = new Float64Array( [ 1, 0, 0, 1, 2, 1, 1, -1 ] );
	var C = new Float64Array( 8 );
	var alpha = new Float64Array( [ 1, 0 ] );
	var beta = new Float64Array( [ 0, 0 ] );
	var result = base( 'T', 'T', 2, 2, 2, alpha, A, 1, 2, 0, B, 1, 2, 0, beta, C, 1, 2, 0 );
	assert.strictEqual( result, C );
	assertArrayClose( Array.from( C ), tc.c, 'zgemm_transA_transB c' );
});
...
test( 'zgemm: transpose A, conjugate B (C=A^T*B^H)', function t() {
	...
	assert.strictEqual( result, C );
	assertArrayClose( Array.from( C ), tc.c, 'zgemm_transA_conjB c' );
});
...
test( 'zgemm: conjugate A, transpose B (C=A^H*B^T)', function t() {
	...
	assert.strictEqual( result, C );
	assertArrayClose( Array.from( C ), tc.c, 'zgemm_conjA_transB c' );
});
...
test( 'zgemm: N,T with non-trivial beta', function t() {
	...
	var C = new Float64Array( [ 1, 1, 2, 2, 3, 3, 4, 4 ] );
	var alpha = new Float64Array( [ 1, 0 ] );
	var beta = new Float64Array( [ 2, 1 ] );
	var result = base( 'N', 'T', 2, 2, 2, alpha, A, 1, 2, 0, B, 1, 2, 0, beta, C, 1, 2, 0 );
	assert.strictEqual( result, C );
	assertArrayClose( Array.from( C ), tc.c, 'zgemm_NT_beta_scale c' );
});
...
test( 'zgemm: C,C with non-zero beta', function t() {
	...
	var C = new Float64Array( [ 1, 1, 2, 2, 3, 3, 4, 4 ] );
	var alpha = new Float64Array( [ 1, 0 ] );
	var beta = new Float64Array( [ 0.5, 0.5 ] );
	var result = base( 'C', 'C', 2, 2, 2, alpha, A, 1, 2, 0, B, 1, 2, 0, beta, C, 1, 2, 0 );
	assert.strictEqual( result, C );
	assertArrayClose( Array.from( C ), tc.c, 'zgemm_CC_beta_nonzero c' );
});
...
test( 'zgemm: N,C with non-trivial beta', function t() {
	...
	var A = new Float64Array( [ 1, 0, 0, 0, 0, 0, 1, 0 ] );
	var B = new Float64Array( [ 1, 1, 2, 2, 3, 3, 4, 4 ] );
	var C = new Float64Array( [ 1, 0, 0, 0, 0, 0, 1, 0 ] );
	var alpha = new Float64Array( [ 1, 0 ] );
	var beta = new Float64Array( [ 2, 0 ] );
	var result = base( 'N', 'C', 2, 2, 2, alpha, A, 1, 2, 0, B, 1, 2, 0, beta, C, 1, 2, 0 );
	assert.strictEqual( result, C );
	assertArrayClose( Array.from( C ), tc.c, 'zgemm_NC_beta_scale c' );
});
...
test( 'zgemm: T,N with non-zero beta', function t() {
	...
	var result = base( 'T', 'N', 2, 2, 2, alpha, A, 1, 2, 0, B, 1, 2, 0, beta, C, 1, 2, 0 );
	assert.strictEqual( result, C );
	assertArrayClose( Array.from( C ), tc.c, 'zgemm_TN_beta_nonzero c' );
});
...
test( 'zgemm: C,N with non-zero beta', function t() {
	...
	var result = base( 'C', 'N', 2, 2, 2, alpha, A, 1, 2, 0, B, 1, 2, 0, beta, C, 1, 2, 0 );
	assert.strictEqual( result, C );
	assertArrayClose( Array.from( C ), tc.c, 'zgemm_CN_beta_nonzero c' );
});
...
test( 'zgemm: C,T with non-zero beta', function t() {
	...
	var C = new Float64Array( [ 1, 1, 2, 2, 3, 3, 4, 4 ] );
	var alpha = new Float64Array( [ 1, 0 ] );
	var beta = new Float64Array( [ 0.5, 0 ] );
	var result = base( 'C', 'T', 2, 2, 2, alpha, A, 1, 2, 0, B, 1, 2, 0, beta, C, 1, 2, 0 );
	assert.strictEqual( result, C );
	assertArrayClose( Array.from( C ), tc.c, 'zgemm_CT_beta_nonzero c' );
});
...
test( 'zgemm: T,C with non-zero beta', function t() {
	...
	var result = base( 'T', 'C', 2, 2, 2, alpha, A, 1, 2, 0, B, 1, 2, 0, beta, C, 1, 2, 0 );
	assert.strictEqual( result, C );
	assertArrayClose( Array.from( C ), tc.c, 'zgemm_TC_beta_nonzero c' );
});
...
test( 'zgemm: T,T with non-zero beta', function t() {
	...
	var result = base( 'T', 'T', 2, 2, 2, alpha, A, 1, 2, 0, B, 1, 2, 0, beta, C, 1, 2, 0 );
	assert.strictEqual( result, C );
	assertArrayClose( Array.from( C ), tc.c, 'zgemm_TT_beta_nonzero c' );
});
