...
/**
* Solves one of the systems of equations `A*x = b`, `A**T*x = b`, or `A**H*x = b` where `A` is an `N` by `N` upper or lower triangular complex matrix.
*
...
*
* ztrsv( 'upper', 'no-transpose', 'non-unit', 2, A, 1, 2, 0, x, 1, 0 );
*/
