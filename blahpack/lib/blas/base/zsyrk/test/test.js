...
test( 'zsyrk: K=0 with beta!=1 still scales C', function t() {
	...
	zsyrk( 'upper', 'no-transpose', 1, 0, new Complex128( 1, 0 ), A, 1, 1, 0, new Complex128( 2, 1 ), C, 1, 1, 0 );
	// beta*C = (2+i)*(3+4i) = 6+8i+3i+4i^2 = 6+11i-4 = 2+11i
...
test( 'zsyrk: lower alpha_zero scaling', function t() {
	...
	zsyrk( 'lower', 'no-transpose', 2, 2, new Complex128( 0, 0 ), A, 1, 2, 0, new Complex128( 0.5, 0.5 ), C, 1, 2, 0 );
	var Cv = reinterpret( C, 0 );
...
test( 'zsyrk: lower alpha_zero beta_zero zeroes lower triangle', function t() {
	var A = new Complex128Array( 4 );
	var C = new Complex128Array( [ 1, 2, 3, 4, 5, 6, 7, 8 ] );
	zsyrk( 'lower', 'no-transpose', 2, 2, new Complex128( 0, 0 ), A, 1, 2, 0, new Complex128( 0, 0 ), C, 1, 2, 0 );
	var Cv = reinterpret( C, 0 );
...
test( 'zsyrk: upper trans with nonzero beta', function t() {
	...
	var A = new Complex128Array( [ 1, 0.5, 2, -1, 3, 1, 4, 2, 5, 0, 6, -0.5 ] );
	// C is 2x2 with initial values
	var C = new Complex128Array( [ 1, 1, 0, 0, 0, 0, 2, -1 ] );
	zsyrk( 'upper', 'transpose', 2, 3, new Complex128( 1, 0 ), A, 1, 3, 0, new Complex128( 0.5, 0 ), C, 1, 2, 0 );
	var Cv = reinterpret( C, 0 );
...
test( 'zsyrk: lower trans with nonzero beta', function t() {
	...
	var A = new Complex128Array( [ 1, 0.5, 2, -1, 3, 1, 4, 2, 5, 0, 6, -0.5 ] );
	var C = new Complex128Array( [ 1, 1, 0, 0, 0, 0, 2, -1 ] );
	zsyrk( 'lower', 'transpose', 2, 3, new Complex128( 1, 0 ), A, 1, 3, 0, new Complex128( 0.5, 0 ), C, 1, 2, 0 );
	var Cv = reinterpret( C, 0 );
	// C[0,0] = same as upper
	assertClose( Cv[ 0 ], 12.25, 1e-14, 'C00r' );
	assertClose( Cv[ 1 ], 3.5, 1e-14, 'C00i' );
...
test( 'zsyrk: complex alpha with transpose', function t() {
	...
	var C = new Complex128Array( 4 ); // 2x2 zeroed
	zsyrk( 'upper', 'transpose', 2, 2, new Complex128( 1, 1 ), A, 1, 2, 0, new Complex128( 0, 0 ), C, 1, 2, 0 );
	var Cv = reinterpret( C, 0 );
...
test( 'zsyrk: K=0 alpha=1 beta=1 quick return', function t() {
	...
	zsyrk( 'upper', 'no-transpose', 1, 0, new Complex128( 1, 0 ), A, 1, 1, 0, new Complex128( 1, 0 ), C, 1, 1, 0 );
	var Cv = reinterpret( C, 0 );
...
test( 'zsyrk: complex beta scaling with alpha_zero lower', function t() {
	...
	var A = new Complex128Array( 4 );
	// C: col0: (1,0) (0,1); col1: (2,0) (3,0)
	var C = new Complex128Array( [ 1, 0, 0, 1, 2, 0, 3, 0 ] );
	zsyrk( 'lower', 'no-transpose', 2, 2, new Complex128( 0, 0 ), A, 1, 2, 0, new Complex128( 1, 2 ), C, 1, 2, 0 );
	var Cv = reinterpret( C, 0 );
	// C[0,0] = (1+2i)*(1+0i) = (1,2)
	assertClose( Cv[ 0 ], 1.0, 1e-14, 'C00r' );
