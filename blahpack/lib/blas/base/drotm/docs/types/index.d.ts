...
interface Routine {
	...
	* @returns result
	*/
	ndarray( N: number, x: Float64Array, strideX: number, offsetX: number, y: Float64Array, strideY: number, offsetY: number, param: Float64Array, strideParam: number, offsetParam: number ): Float64Array;
}
