...
interface Routine {
	...
	* @returns result
	*/
	ndarray( trans: TransposeOperation, M: number, N: number, kl: number, ku: number, alpha: number, A: Float64Array, strideA1: number, strideA2: number, offsetA: number, x: Float64Array, strideX: number, offsetX: number, beta: number, y: Float64Array, strideY: number, offsetY: number ): Float64Array;
}
