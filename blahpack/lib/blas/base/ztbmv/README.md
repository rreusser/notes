...
#### ztbmv( order, uplo, trans, diag, N, K, A, LDA, x, strideX )
...
-   `ztbmv()` corresponds to the [LAPACK][lapack] level routine [`ztbmv`][lapack-ztbmv].
...
[lapack-ztbmv]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__ztbmv.html
