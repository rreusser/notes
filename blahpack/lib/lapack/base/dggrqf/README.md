...
-   `dggrqf()` corresponds to the [LAPACK][lapack] level routine [`dggrqf`][lapack-dggrqf].
...
[lapack-dggrqf]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dggrqf.html
