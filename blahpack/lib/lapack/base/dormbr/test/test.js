...
test( 'dormbr: VECT=Q, SIDE=L, TRANS=N (upper bidiagonal, NQ>=K)', function t() {
	...
	var info = dormbr( 'Q', 'L', 'N', 4, 4, 3, A, 1, 4, 0, TAUQ, 1, 0, C, 1, 4, 0, WORK, 1, 0, 1000 );
	assert.equal( info, 0 );
...
test( 'dormbr: VECT=Q, SIDE=L, TRANS=T (upper bidiagonal)', function t() {
	...
	var C = eye( 4, 4 );
	var WORK = new Float64Array( 1000 );
	var info = dormbr( 'Q', 'L', 'T', 4, 4, 3, A, 1, 4, 0, TAUQ, 1, 0, C, 1, 4, 0, WORK, 1, 0, 1000 );
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=P, SIDE=R, TRANS=N (upper bidiagonal, NQ>=K)', function t() {
	...
	var info = dormbr( 'P', 'R', 'N', 3, 3, 3, A, 1, 4, 0, TAUP, 1, 0, C, 1, 3, 0, WORK, 1, 0, 1000 );
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=P, SIDE=R, TRANS=T (upper bidiagonal)', function t() {
	...
	var C = eye( 3, 3 );
	var WORK = new Float64Array( 1000 );
	var info = dormbr( 'P', 'R', 'T', 3, 3, 3, A, 1, 4, 0, TAUP, 1, 0, C, 1, 3, 0, WORK, 1, 0, 1000 );
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=Q, SIDE=R, TRANS=N (upper bidiagonal)', function t() {
	...
	var info = dormbr( 'Q', 'R', 'N', 4, 4, 3, A, 1, 4, 0, TAUQ, 1, 0, C, 1, 4, 0, WORK, 1, 0, 1000 );
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=P, SIDE=L, TRANS=N (upper bidiagonal)', function t() {
	...
	var info = dormbr( 'P', 'L', 'N', 3, 3, 3, A, 1, 4, 0, TAUP, 1, 0, C, 1, 3, 0, WORK, 1, 0, 1000 );
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=Q, SIDE=R, TRANS=T (upper bidiagonal)', function t() {
	...
	var C = eye( 4, 4 );
	var WORK = new Float64Array( 1000 );
	var info = dormbr( 'Q', 'R', 'T', 4, 4, 3, A, 1, 4, 0, TAUQ, 1, 0, C, 1, 4, 0, WORK, 1, 0, 1000 );
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=P, SIDE=L, TRANS=T (upper bidiagonal)', function t() {
	...
	var C = eye( 3, 3 );
	var WORK = new Float64Array( 1000 );
	var info = dormbr( 'P', 'L', 'T', 3, 3, 3, A, 1, 4, 0, TAUP, 1, 0, C, 1, 3, 0, WORK, 1, 0, 1000 );
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=Q, SIDE=L, TRANS=N (lower bidiagonal, NQ<K)', function t() {
	...
	var info = dormbr( 'Q', 'L', 'N', 3, 3, 4, A, 1, 3, 0, TAUQ, 1, 0, C, 1, 3, 0, WORK, 1, 0, 1000 );
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=Q, SIDE=L, TRANS=T (lower bidiagonal, NQ<K)', function t() {
	...
	var C = eye( 3, 3 );
	var WORK = new Float64Array( 1000 );
	var info = dormbr( 'Q', 'L', 'T', 3, 3, 4, A, 1, 3, 0, TAUQ, 1, 0, C, 1, 3, 0, WORK, 1, 0, 1000 );
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=P, SIDE=R, TRANS=N (lower bidiagonal, NQ>K)', function t() {
	...
	var info = dormbr( 'P', 'R', 'N', 4, 4, 3, A, 1, 3, 0, TAUP, 1, 0, C, 1, 4, 0, WORK, 1, 0, 1000 );
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=P, SIDE=R, TRANS=T (lower bidiagonal, NQ>K)', function t() {
	...
	var C = eye( 4, 4 );
	var WORK = new Float64Array( 1000 );
	var info = dormbr( 'P', 'R', 'T', 4, 4, 3, A, 1, 3, 0, TAUP, 1, 0, C, 1, 4, 0, WORK, 1, 0, 1000 );
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=P, SIDE=L, TRANS=N (lower bidiagonal, NQ>K)', function t() {
	...
	var info = dormbr( 'P', 'L', 'N', 4, 4, 3, A, 1, 3, 0, TAUP, 1, 0, C, 1, 4, 0, WORK, 1, 0, 1000 );
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=P, SIDE=L, TRANS=T (lower bidiagonal, NQ>K)', function t() {
	...
	var C = eye( 4, 4 );
	var WORK = new Float64Array( 1000 );
	var info = dormbr( 'P', 'L', 'T', 4, 4, 3, A, 1, 3, 0, TAUP, 1, 0, C, 1, 4, 0, WORK, 1, 0, 1000 );
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=Q, SIDE=R, TRANS=N (lower bidiagonal, NQ<K)', function t() {
	...
	var info = dormbr( 'Q', 'R', 'N', 3, 3, 4, A, 1, 3, 0, TAUQ, 1, 0, C, 1, 3, 0, WORK, 1, 0, 1000 );
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=Q, SIDE=R, TRANS=T (lower bidiagonal, NQ<K)', function t() {
	...
	var C = eye( 3, 3 );
	var WORK = new Float64Array( 1000 );
	var info = dormbr( 'Q', 'R', 'T', 3, 3, 4, A, 1, 3, 0, TAUQ, 1, 0, C, 1, 3, 0, WORK, 1, 0, 1000 );
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=Q, SIDE=L, TRANS=N, non-identity C (upper bidiagonal)', function t() {
	...
	var WORK = new Float64Array( 1000 );
	var info = dormbr( 'Q', 'L', 'N', 4, 2, 3, A, 1, 4, 0, TAUQ, 1, 0, C, 1, 4, 0, WORK, 1, 0, 1000 );
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=P, SIDE=R, TRANS=N, non-identity C (lower bidiagonal)', function t() {
	...
	var WORK = new Float64Array( 1000 );
	var info = dormbr( 'P', 'R', 'N', 3, 4, 3, A, 1, 3, 0, TAUP, 1, 0, C, 1, 3, 0, WORK, 1, 0, 1000 );
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: M=0 quick return', function t() {
	...
	var info = dormbr( 'Q', 'L', 'N', 0, 3, 0, A, 1, 1, 0, TAU, 1, 0, C, 1, 1, 0, WORK, 1, 0, 1 );
	assert.equal( info, 0 );
});
...
test( 'dormbr: N=0 quick return', function t() {
	...
	var C = new Float64Array( 1 );
	var WORK = new Float64Array( 1 );
	var info = dormbr( 'Q', 'L', 'N', 3, 0, 0, A, 1, 1, 0, TAU, 1, 0, C, 1, 1, 0, WORK, 1, 0, 1 );
	assert.equal( info, 0 );
});
...
test( 'dormbr: K=0, VECT=Q (dormqr with K=0, C unchanged)', function t() {
	...
	var info = dormbr( 'Q', 'L', 'N', 4, 4, 0, A, 1, 4, 0, TAU, 1, 0, C, 1, 4, 0, WORK, 1, 0, 1000 );
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
