...
-   `zsycon()` corresponds to the [LAPACK][lapack] level routine [`zsycon`][lapack-zsycon].
...
[lapack-zsycon]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zsycon.html
