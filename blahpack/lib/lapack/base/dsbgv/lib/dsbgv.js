...
*/
function dsbgv( order, jobz, uplo, N, ka, kb, AB, LDAB, BB, LDBB, w, strideW, Z, LDZ, WORK, strideWORK ) {
	var sbb1;
	var sbb2;
	var sab1;
	var sab2;
	...
	owk = stride2offset( Math.max( 1, 3 * N ), strideWORK );
	return base( jobz, uplo, N, ka, kb, AB, sab1, sab2, 0, BB, sbb1, sbb2, 0, w, strideW, ow, Z, sz1, sz2, 0, WORK, strideWORK, owk );
}
