...
*
* @module @stdlib/lapack/base/zgetrs
*
* @example
...
*
* zgetrs( 'row-major', 'no-transpose', 2, 1, A, 2, IPIV, 1, B, 2 );
*
* @example
* var Complex128Array = require( '@stdlib/array/complex128' );
* var Int32Array = require( '@stdlib/array/int32' );
...
* var B = new Complex128Array( [ 1.0, 2.0, 3.0, 4.0 ] );
*
* zgetrs.ndarray( 'no-transpose', 2, 1, A, 1, 2, 0, IPIV, 1, 0, B, 1, 2, 0 );
*/
...
// exports: { "ndarray": "zgetrs.ndarray" }
