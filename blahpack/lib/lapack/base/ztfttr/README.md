...
#### ztfttr( order, transr, uplo, N, ARF, A, LDA )
...
-   `ztfttr()` corresponds to the [LAPACK][lapack] level routine [`ztfttr`][lapack-ztfttr].
...
[lapack-ztfttr]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__ztfttr.html
