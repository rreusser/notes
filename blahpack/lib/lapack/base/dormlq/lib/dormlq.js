...
* @returns {*} result
*/
function dormlq( order, side, trans, M, N, K, A, LDA, TAU, strideTAU, C, LDC, WORK, strideWORK, lwork ) {
	var sa1;
	var sa2;
	var sc1;
	var sc2;
	...
	return base( side, trans, M, N, K, A, sa1, sa2, 0, TAU, strideTAU, ot, C, sc1, sc2, 0, WORK, strideWORK, ow, lwork );
}
