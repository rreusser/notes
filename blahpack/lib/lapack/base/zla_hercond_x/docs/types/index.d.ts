...
/**
* Interface describing `zla_hercond_x`.
*/
interface Routine {
	/**
	...
	* @returns result
	*/
	( order: Layout, uplo: string, N: number, A: Float64Array, LDA: number, AF: Float64Array, LDAF: number, IPIV: Int32Array, strideIPIV: number, offsetIPIV: number, x: Float64Array, strideX: number, WORK: Float64Array, strideWORK: number, RWORK: Float64Array, strideRWORK: number ): Float64Array;
...
* Estimates the infinity norm condition number for a Hermitian indefinite matrix with x scaling
*/
declare var zla_hercond_x: Routine;


// EXPORTS //

export = zla_hercond_x;
