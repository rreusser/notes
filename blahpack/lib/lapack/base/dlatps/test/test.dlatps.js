...
test( 'dlatps throws TypeError for invalid uplo', function t() {
	assert.throws( function throws() {
		dlatps( 'invalid', 'no-transpose', 'non-unit', 2, new Float64Array( 4 ), new Float64Array( 4 ), 2, 1, 2, new Float64Array( 4 ), 1 );
	}, TypeError );
});

test( 'dlatps throws TypeError for invalid trans', function t() {
	assert.throws( function throws() {
		dlatps( 'upper', 'invalid', 'non-unit', 2, new Float64Array( 4 ), new Float64Array( 4 ), 2, 1, 2, new Float64Array( 4 ), 1 );
	}, TypeError );
});

test( 'dlatps throws TypeError for invalid diag', function t() {
	assert.throws( function throws() {
		dlatps( 'upper', 'no-transpose', 'invalid', 2, new Float64Array( 4 ), new Float64Array( 4 ), 2, 1, 2, new Float64Array( 4 ), 1 );
	}, TypeError );
});

test( 'dlatps throws RangeError for negative N', function t() {
	assert.throws( function throws() {
		dlatps( 'upper', 'no-transpose', 'non-unit', 2, -1, new Float64Array( 4 ), 2, 1, 2, new Float64Array( 4 ), 1 );
	}, RangeError );
});
