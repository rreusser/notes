...
-   `dptsvx()` corresponds to the [LAPACK][lapack] level routine [`dptsvx`][lapack-dptsvx].
...
[lapack-dptsvx]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dptsvx.html
