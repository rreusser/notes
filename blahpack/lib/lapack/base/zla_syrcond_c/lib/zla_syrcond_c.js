...
*/
function zla_syrcond_c( order, uplo, N, A, LDA, AF, LDAF, IPIV, strideIPIV, offsetIPIV, c, strideC, capply, WORK, strideWORK, RWORK, strideRWORK ) { // eslint-disable-line max-len, max-params
	var saf1;
	var saf2;
	var sa1;
	var sa2;
