...
*
* @module @stdlib/lapack/base/zunml2
*
* @example
...
* 
* zunml2( 'row-major', 'left', 'no-transpose', 2, 2, 2, A, 2, TAU, 1, C, 2, WORK, 1 );
*
* @example
...
* 
* zunml2.ndarray( 'left', 'no-transpose', 2, 2, 2, A, 1, 2, 0, TAU, 1, 0, C, 1, 2, 0, WORK, 1, 0 );
*/
...
// exports: { "ndarray": "zunml2.ndarray" }
