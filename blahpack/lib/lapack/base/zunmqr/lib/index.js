...
*
* @module @stdlib/lapack/base/zunmqr
*
* @example
...
* 
* zunmqr( 'row-major', 'left', 'no-transpose', 2, 2, 2, A, 2, TAU, 1, C, 2, WORK, 1, 8 );
*
* @example
...
* 
* zunmqr.ndarray( 'left', 'no-transpose', 2, 2, 2, A, 1, 2, 0, TAU, 1, 0, C, 1, 2, 0, WORK, 1, 0, 8 );
*/
...
// exports: { "ndarray": "zunmqr.ndarray" }
