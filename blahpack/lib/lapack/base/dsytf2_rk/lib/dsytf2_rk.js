...
*/
function dsytf2rk( order, uplo, N, A, LDA, e, strideE, IPIV, strideIPIV, offsetIPIV ) { // eslint-disable-line max-len, max-params
	var sa1;
	var sa2;
	...
	return base( uplo, N, A, sa1, sa2, 0, e, strideE, 0, IPIV, strideIPIV, offsetIPIV ); // eslint-disable-line max-len
}
