...
#### dposv.ndarray( uplo, N, nrhs, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB )
...
-   `dposv()` corresponds to the [LAPACK][lapack] level routine [`dposv`][lapack-dposv].
...
[lapack-dposv]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dposv.html
