...
-   `dlange()` corresponds to the [LAPACK][lapack] level routine [`dlange`][lapack-dlange].
...
[lapack-dlange]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dlange.html
