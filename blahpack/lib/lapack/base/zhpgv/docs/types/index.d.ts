...
interface Routine {
	...
	* @returns result
	*/
	( order: Layout, itype: number, jobz: string, uplo: MatrixTriangle, N: number, AP: Float64Array, BP: Float64Array, w: Float64Array, Z: Float64Array, LDZ: number, WORK: Float64Array, RWORK: Float64Array ): Float64Array;
