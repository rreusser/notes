...
#### zhpgv( order, itype, jobz, uplo, N, AP, BP, w, Z, LDZ, WORK, RWORK )
...
-   `zhpgv()` corresponds to the [LAPACK][lapack] level routine [`zhpgv`][lapack-zhpgv].
...
[lapack-zhpgv]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zhpgv.html
