...
#### dtfttr( order, transr, uplo, N, ARF, A, LDA )
...
-   `dtfttr()` corresponds to the [LAPACK][lapack] level routine [`dtfttr`][lapack-dtfttr].
...
[lapack-dtfttr]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dtfttr.html
