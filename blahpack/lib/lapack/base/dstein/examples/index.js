...
var out = dstein( N, d, 1, e, 1, N, w, 1, IBLOCK, 1, ISPLIT, 1, Z, N, WORK, 1, IWORK, 1, IFAIL, 1 );
console.log( out );

// Using the ndarray interface:
out = dstein.ndarray( N, d, 1, 0, e, 1, 0, N, w, 1, 0, IBLOCK, 1, 0, ISPLIT, 1, 0, Z, N, 1, 0, WORK, 1, 0, IWORK, 1, 0, IFAIL, 1, 0 );
console.log( out );
