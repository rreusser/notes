...
*/
function dspevx( order, jobz, range, uplo, N, AP, vl, vu, il, iu, abstol, out, w, Z, LDZ, WORK, IWORK, IFAIL ) {
	var sz1;
	var sz2;
	...
	return base( jobz, range, uplo, N, AP, 1, 0, vl, vu, il, iu, abstol, out, w, 1, 0, Z, sz1, sz2, 0, WORK, 1, 0, IWORK, 1, 0, IFAIL, 1, 0 );
}
