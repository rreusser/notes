...
*/
function zsytri3( order, uplo, N, A, LDA, e, strideE, IPIV, strideIPIV, offsetIPIV, WORK, strideWORK, lwork ) { // eslint-disable-line max-len, max-params
	var sa1;
	var sa2;
	...
	return base( uplo, N, A, sa1, sa2, 0, e, strideE, 0, IPIV, strideIPIV, offsetIPIV, WORK, strideWORK, 0, lwork );
}
