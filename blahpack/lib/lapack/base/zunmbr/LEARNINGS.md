...
- String parameters (`side`, `trans`, `transt`, `vect`) use single-char Fortran convention in base.js; ndarray.js normalizes from stdlib full-word strings.
...
- All parameter combinations for `side`, `trans`, `transt`, `vect` should be tested to ensure full branch coverage.
