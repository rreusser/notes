...
* @param {Float64Array} A - factored matrix from `dsytrf_rk`
...
*/
function dsycon3( order, uplo, N, A, LDA, e, strideE, IPIV, strideIPIV, anorm, rcond, WORK, strideWORK, IWORK, strideIWORK ) {
	var oiwork;
	var oipiv;
	var owork;
	var sa1;
	...
	return base( uplo, N, A, sa1, sa2, 0, e, strideE, oe, IPIV, strideIPIV, oipiv, anorm, rcond, WORK, strideWORK, owork, IWORK, strideIWORK, oiwork );
}
