...
/**
* Solves a system of linear equations `A * X = B` with a complex Hermitian
* matrix A stored in packed format, using the factorization `A = U * D * U**H`
...
* @param {Complex128Array} AP - factored packed Hermitian matrix
...
*/
function zhptrs( order, uplo, N, nrhs, AP, IPIV, B, LDB ) {
	var sb1;
	var sb2;
