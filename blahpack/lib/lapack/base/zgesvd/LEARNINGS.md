...
- String parameters (`direct`, `jobu`, `jobvt`) use single-char Fortran convention in base.js; ndarray.js normalizes from stdlib full-word strings.
...
- All parameter combinations for `direct`, `jobu`, `jobvt` should be tested to ensure full branch coverage.
