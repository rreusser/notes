...
-   `dorm2r()` corresponds to the [LAPACK][lapack] level routine [`dorm2r`][lapack-dorm2r].
...
[lapack-dorm2r]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dorm2r.html
