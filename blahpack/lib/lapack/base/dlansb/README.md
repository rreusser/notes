...
Returns the norm of a real symmetric band matrix, using alternative indexing semantics.
...
-   `dlansb()` corresponds to the [LAPACK][lapack] level routine [`dlansb`][lapack-dlansb].
...
[lapack-dlansb]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dlansb.html
