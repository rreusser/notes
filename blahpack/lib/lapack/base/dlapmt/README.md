...
-   `dlapmt()` corresponds to the [LAPACK][lapack] level routine [`dlapmt`][lapack-dlapmt].
...
[lapack-dlapmt]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dlapmt.html
