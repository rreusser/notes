...
-   `dgtcon()` corresponds to the [LAPACK][lapack] level routine [`dgtcon`][lapack-dgtcon].
...
[lapack-dgtcon]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dgtcon.html
