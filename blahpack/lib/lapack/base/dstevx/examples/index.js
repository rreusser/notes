...
var out = dstevx( 'V', 'A', N, d, 1, e, 1, 1.0, 1.0, N, N, 1.0, N, w, 1, Z, N, WORK, 1, IWORK, 1, IFAIL, 1 );
console.log( out );

// Using the ndarray interface:
out = dstevx.ndarray( 'V', 'A', N, d, 1, 0, e, 1, 0, 1.0, 1.0, N, N, 1.0, N, w, 1, 0, Z, N, 1, 0, WORK, 1, 0, IWORK, 1, 0, IFAIL, 1, 0 );
console.log( out );
