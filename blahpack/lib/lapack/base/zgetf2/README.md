...
#### zgetf2( order, M, N, A, LDA, IPIV, strideIPIV )
...
-   `zgetf2()` corresponds to the [LAPACK][lapack] level routine [`zgetf2`][lapack-zgetf2].
...
[lapack-zgetf2]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zgetf2.html
