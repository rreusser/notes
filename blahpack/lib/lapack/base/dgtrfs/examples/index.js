...
var out = dgtrfs( 'no-transpose', N, N, DL, 1, d, 1, DU, 1, DLF, 1, DF, 1, DUF, 1, 1, 1, IPIV, 1, B, N, X, N, FERR, 1, BERR, 1, WORK, 1, IWORK, 1 );
console.log( out );

// Using the ndarray interface:
out = dgtrfs.ndarray( 'no-transpose', N, N, DL, 1, 0, d, 1, 0, DU, 1, 0, DLF, 1, 0, DF, 1, 0, DUF, 1, 0, 1, 1, 0, IPIV, 1, 0, B, N, 1, 0, X, N, 1, 0, FERR, 1, 0, BERR, 1, 0, WORK, 1, 0, IWORK, 1, 0 );
console.log( out );
