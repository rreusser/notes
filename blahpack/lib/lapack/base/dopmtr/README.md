...
-   `dopmtr()` corresponds to the [LAPACK][lapack] level routine [`dopmtr`][lapack-dopmtr].
...
[lapack-dopmtr]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dopmtr.html
