...
-   `ztrtrs()` corresponds to the [LAPACK][lapack] level routine [`ztrtrs`][lapack-ztrtrs].
...
[lapack-ztrtrs]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__ztrtrs.html
