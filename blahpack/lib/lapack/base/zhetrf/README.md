...
-   `zhetrf()` corresponds to the [LAPACK][lapack] level routine [`zhetrf`][lapack-zhetrf].
...
[lapack-zhetrf]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zhetrf.html
