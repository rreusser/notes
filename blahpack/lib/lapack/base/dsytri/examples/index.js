...
var dsytri = require( './../lib' );

// 3x3 symmetric positive definite matrix (column-major), already factored:

// The diagonal of D and the multipliers from the factorization are stored in A.
var A = new Float64Array( [ 4.0, 0.5, 0.25, 0.0, 2.0, 0.5, 0.0, 0.0, 1.0 ] );
var IPIV = new Int32Array( [ 0, 1, 2 ] );
var WORK = new Float64Array( 3 );

var info = dsytri( 'column-major', 'upper', 3, A, 3, IPIV, 1, WORK );
