...
*/
function dla_syrcond( order, uplo, N, A, LDA, AF, LDAF, IPIV, strideIPIV, offsetIPIV, cmode, c, strideC, WORK, strideWORK, IWORK, strideIWORK, offsetIWORK ) { // eslint-disable-line max-len, max-params
	var saf1;
	var saf2;
	var sa1;
	var sa2;
	...
	return base( uplo, N, A, sa1, sa2, 0, AF, saf1, saf2, 0, IPIV, strideIPIV, offsetIPIV, cmode, c, strideC, 0, WORK, strideWORK, 0, IWORK, strideIWORK, offsetIWORK ); // eslint-disable-line max-len
}
