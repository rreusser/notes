...
-   `dgetrs()` corresponds to the [LAPACK][lapack] level routine [`dgetrs`][lapack-dgetrs].
...
[lapack-dgetrs]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dgetrs.html
