...
* @returns {*} result
*/
function dlaqr3( wantt, wantz, N, ktop, kbot, nw, H, LDH, iloz, ihiz, Z, LDZ, SR, strideSR, SI, strideSI, V, LDV, nh, T, LDT, nv, WV, LDWV, WORK, strideWORK, lwork ) { // eslint-disable-line max-len, max-params
	var owork;
	var swv1;
	var swv2;
	var osi;
