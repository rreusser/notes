...
* tridiagonal form by a unitary similarity transformation Q**H * A * Q,
...
*/
function zlatrd( uplo, N, nb, A, strideA1, strideA2, offsetA, e, strideE, offsetE, TAU, strideTAU, offsetTAU, W, strideW1, strideW2, offsetW ) { // eslint-disable-line max-len, max-params
	var alphaR;
	var alphaI;
	var tauiR;
	var tauiI;
