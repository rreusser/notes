...
> Computes the modified LU factorization without pivoting of a general M-by-N matrix (recursive kernel).
...
#### dlaorhr_col_getrfnp2( order, M, N, A, LDA, d, strideD )
...
#### dlaorhr_col_getrfnp2.ndarray( M, N, A, strideA1, strideA2, offsetA, d, strideD, offsetD )

Computes the modified LU factorization without pivoting of a general M-by-N matrix (recursive kernel)., using alternative indexing semantics.
...
dlaorhr_col_getrfnp2.ndarray( 3, 3, A, 1, 3, 0, D, 1, 0 );
```
...
-   This routine is used by the Householder reconstruction routine `dorhr_col`.
