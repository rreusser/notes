...
-   `zposvx()` corresponds to the [LAPACK][lapack] level routine [`zposvx`][lapack-zposvx].
...
[lapack-zposvx]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zposvx.html
