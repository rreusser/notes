...
var out = zposvx( 'N', 'upper', N, N, A, N, AF, N, 'N', s, 1, B, N, X, N, 1.0, FERR, 1, BERR, 1, WORK, 1, RWORK, 1 );
console.log( out );

// Using the ndarray interface:
out = zposvx.ndarray( 'N', 'upper', N, N, A, N, 1, 0, AF, N, 1, 0, 'N', s, 1, 0, B, N, 1, 0, X, N, 1, 0, 1.0, FERR, 1, 0, BERR, 1, 0, WORK, 1, 0, RWORK, 1, 0 );
console.log( out );
