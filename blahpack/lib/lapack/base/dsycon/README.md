...
-   `dsycon()` corresponds to the [LAPACK][lapack] level routine [`dsycon`][lapack-dsycon].
...
[lapack-dsycon]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dsycon.html
