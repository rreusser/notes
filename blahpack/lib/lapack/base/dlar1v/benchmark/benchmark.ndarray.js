	...
	*/
	function benchmark( b ) {
		...
		for ( i = 0; i < b.iterations; i += 1 ) {
			r[ 0 ] = 0;
			Z[ 0 ] = 0.0;
			dlar1v( len, 1, len, 4.0 - Math.sqrt( 3.0 ), D, 1, 0, L, 1, 0, LD, 1, 0, LLD, 1, 0, 1e-300, 0.0, Z, 1, 0, true, negcnt, ztz, mingma, r, ISUPPZ, 1, 0, nrminv, resid, rqcorr, WORK, 1, 0 ); // eslint-disable-line max-len
			if ( ztz[ 0 ] !== ztz[ 0 ] ) {
