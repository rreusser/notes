...
interface Routine {
	...
	* @returns result
	*/
	( N: number, alpha: any, x: Float64Array, stride: number, tau: any ): Float64Array;
	...
	* @returns result
	*/
	ndarray( N: number, alpha: any, x: Float64Array, stride: number, offset: number, tau: any ): Float64Array;
}

/**
* Generates a complex elementary reflector with non-negative beta
*/
declare var zlarfgp: Routine;
