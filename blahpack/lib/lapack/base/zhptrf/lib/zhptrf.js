...
* in packed format.
*
* The factorization has the form `A = U*D*U^H` (if uplo = 'upper') or
* `A = L*D*L^H` (if uplo = 'lower'), where U (or L) is a product of
* permutation and unit upper (lower) triangular matrices, and D is Hermitian
...
*/
function zhptrf( uplo, N, AP, IPIV ) {
