...
var out = dlaqr2( 1, 1, N, 1, 1, 1, H, N, 1, 1, Z, N, SR, 1, SI, 1, V, N, 1, T, N, 1, WV, N, WORK, 1, N );
console.log( out );

// Using the ndarray interface:
out = dlaqr2.ndarray( 1, 1, N, 1, 1, 1, H, N, 1, 0, 1, 1, Z, N, 1, 0, 1, 1, SR, 1, 0, SI, 1, 0, V, N, 1, 0, 1, T, N, 1, 0, 1, WV, N, 1, 0, WORK, 1, 0, N );
console.log( out );
