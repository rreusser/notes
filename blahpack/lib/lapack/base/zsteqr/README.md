...
-   `zsteqr()` corresponds to the [LAPACK][lapack] level routine [`zsteqr`][lapack-zsteqr].
...
[lapack-zsteqr]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zsteqr.html
