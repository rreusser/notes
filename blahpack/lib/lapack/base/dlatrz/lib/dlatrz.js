...
*/
function dlatrz( order, M, N, l, A, LDA, TAU, strideTAU, WORK, strideWORK ) { // eslint-disable-line max-len, max-params
	var sa1;
	var sa2;
	...
	return base( M, N, l, A, sa1, sa2, 0, TAU, strideTAU, 0, WORK, strideWORK, 0 ); // eslint-disable-line max-len
}
