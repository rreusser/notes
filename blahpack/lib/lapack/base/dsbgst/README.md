...
#### dsbgst( vect, uplo, N, ka, kb, AB, LDAB, BB, LDBB, X, LDX, WORK )
...
-   `dsbgst()` corresponds to the [LAPACK][lapack] level routine [`dsbgst`][lapack-dsbgst].
...
[lapack-dsbgst]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dsbgst.html
