	...
	*/
	function benchmark( b ) {
		...
		for ( k = 0; k < b.iterations; k++ ) {
			info = zlaHerfsxExtended( 'column-major', 1, 'upper', N, 1, A, N, AF, N, IPIV, false, c, B, N, Y, N, berrOut, 2, errBndsNorm, 1, errBndsComp, 1, RES, AYB, DY, yTail, 1e-10, 10, 0.5, 0.25, false );
			if ( info !== 0 ) {
