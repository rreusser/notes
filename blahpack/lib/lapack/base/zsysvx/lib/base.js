...
var zlansy = require( '../../zlansy/lib/base.js' );
var zsytrf = require( '../../zsytrf/lib/base.js' );
var zsytrs = require( '../../zsytrs/lib/base.js' );
var zsycon = require( '../../zsycon/lib/base.js' );
var zsyrfs = require( '../../zsyrfs/lib/base.js' );
...
* using the diagonal pivoting factorization A = U*D*U^T or A = L*D*L^T,
