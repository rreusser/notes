...
-   `zpotrs()` corresponds to the [LAPACK][lapack] level routine [`zpotrs`][lapack-zpotrs].
...
[lapack-zpotrs]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zpotrs.html
