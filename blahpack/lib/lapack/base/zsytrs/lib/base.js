...
var _cdR = 0.0; var _cdI = 0.0;
function cDiv( ar, ai, br, bi ) { var r; var d; if ( Math.abs( bi ) <= Math.abs( br ) ) { r = bi / br; d = br + (bi * r); _cdR = ( ar + (ai * r) ) / d; _cdI = ( ai - (ar * r) ) / d; } else { r = br / bi; d = bi + (br * r); _cdR = ( (ar * r) + ai ) / d; _cdI = ( (ai * r) - ar ) / d; } }
