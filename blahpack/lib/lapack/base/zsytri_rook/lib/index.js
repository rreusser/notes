...
/**
* Compute the inverse of a complex symmetric indefinite matrix using the factorization from `zsytrf_rook` (rook pivoting Bunch-Kaufman).
*
* @module @stdlib/lapack/base/zsytri-rook
*
* @example
...
// exports: { "ndarray": "zsytriRook.ndarray" }
