...
var out = dstevr( 'V', 'A', N, d, 1, e, 1, 1.0, 1.0, N, N, 1.0, 1, w, 1, Z, N, ISUPPZ, 1, WORK, 1, N, IWORK, 1, 1 );
console.log( out );

// Using the ndarray interface:
out = dstevr.ndarray( 'V', 'A', N, d, 1, 0, e, 1, 0, 1.0, 1.0, N, N, 1.0, 1, w, 1, 0, Z, N, 1, 0, ISUPPZ, 1, 0, WORK, 1, 0, N, IWORK, 1, 0, 1 );
console.log( out );
