...
var out = zbdsqr( 'row-major', 'upper', N, N, N, N, d, 1, e, 1, VT, N, U, N, C, N, RWORK, 1 );
console.log( out );

// Using the ndarray interface:
out = zbdsqr.ndarray( 'upper', N, N, N, N, d, 1, 0, e, 1, 0, VT, N, 1, 0, U, N, 1, 0, C, N, 1, 0, RWORK, 1, 0 );
console.log( out );
