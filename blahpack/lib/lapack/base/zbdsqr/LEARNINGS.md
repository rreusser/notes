...
- String parameters (`sort`, `uplo`) use single-char Fortran convention in base.js; ndarray.js normalizes from stdlib full-word strings.
...
- Dependencies: `zdrot`, `zdscal`, `zswap`. No unexpected interface issues encountered.
...
- All parameter combinations for `sort`, `uplo` should be tested to ensure full branch coverage.
