...
#### zbdsqr( order, uplo, N, ncvt, nru, ncc, d, strideD, e, strideE, VT, LDVT, U, LDU, C, LDC, RWORK, strideRWORK )
...
-   `zbdsqr()` corresponds to the [LAPACK][lapack] level routine [`zbdsqr`][lapack-zbdsqr].
...
[lapack-zbdsqr]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zbdsqr.html
