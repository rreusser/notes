...
-   `zgebrd()` corresponds to the [LAPACK][lapack] level routine [`zgebrd`][lapack-zgebrd].
...
[lapack-zgebrd]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zgebrd.html
