...
* @returns {*} result
*/
function zgebrd( order, M, N, A, LDA, d, strideD, e, strideE, TAUQ, strideTAUQ, TAUP, strideTAUP, WORK, strideWORK, lwork ) {
	var sa1;
	var sa2;
	var od;
	var oe;
	...
	return base( M, N, A, sa1, sa2, 0, d, strideD, od, e, strideE, oe, TAUQ, strideTAUQ, ot, TAUP, strideTAUP, ot, WORK, strideWORK, ow, lwork );
}
