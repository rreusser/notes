...
-   `dgttrs()` corresponds to the [LAPACK][lapack] level routine [`dgttrs`][lapack-dgttrs].
...
[lapack-dgttrs]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dgttrs.html
