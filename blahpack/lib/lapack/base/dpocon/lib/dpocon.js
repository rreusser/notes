...
* @returns {*} result
*/
function dpocon( order, uplo, N, A, LDA, anorm, rcond, WORK, strideWORK, IWORK, strideIWORK ) {
	var sa1;
	var sa2;
	var ow;
	var oi;
	...
	return base( uplo, N, A, sa1, sa2, 0, anorm, rcond, WORK, strideWORK, ow, IWORK, strideIWORK, oi );
}
