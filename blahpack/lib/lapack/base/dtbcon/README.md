...
-   `dtbcon()` corresponds to the [LAPACK][lapack] level routine [`dtbcon`][lapack-dtbcon].
...
[lapack-dtbcon]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dtbcon.html
