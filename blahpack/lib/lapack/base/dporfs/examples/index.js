...
var out = dporfs( 'upper', N, N, A, N, AF, N, B, N, X, N, FERR, 1, BERR, 1 );
console.log( out );

// Using the ndarray interface:
out = dporfs.ndarray( 'upper', N, N, A, N, 1, 0, AF, N, 1, 0, B, N, 1, 0, X, N, 1, 0, FERR, 1, 0, BERR, 1, 0, WORK, 1, 0, IWORK, 1, 0 );
console.log( out );
