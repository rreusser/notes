...
/**
* Solves a system of linear equations `A*X = B` with a real symmetric matrix `A` using the factorization computed by `dsytrf_rook`.
*
...
*/
function dsytrsRook( order, uplo, N, nrhs, A, LDA, IPIV, strideIPIV, B, LDB ) {
	var sa1;
	var sa2;
	var sb1;
	var sb2;
