...
-   `dpftri()` corresponds to the [LAPACK][lapack] level routine [`dpftri`][lapack-dpftri].
...
[lapack-dpftri]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dpftri.html
