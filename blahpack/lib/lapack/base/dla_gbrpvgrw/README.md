...
-   `dla_gbrpvgrw()` corresponds to the [LAPACK][lapack] level routine [`dla_gbrpvgrw`][lapack-dla_gbrpvgrw].
...
[lapack-dla_gbrpvgrw]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dla_gbrpvgrw.html
