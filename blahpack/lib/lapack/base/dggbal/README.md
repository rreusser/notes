...
#### dggbal( order, job, N, A, LDA, B, LDB, LSCALE, strideLSCALE, RSCALE, strideRSCALE, WORK, strideWORK )
...
-   `dggbal()` corresponds to the [LAPACK][lapack] level routine [`dggbal`][lapack-dggbal].
...
[lapack-dggbal]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dggbal.html
