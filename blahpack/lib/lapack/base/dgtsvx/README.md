...
-   `dgtsvx()` corresponds to the [LAPACK][lapack] level routine [`dgtsvx`][lapack-dgtsvx].
...
[lapack-dgtsvx]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dgtsvx.html
