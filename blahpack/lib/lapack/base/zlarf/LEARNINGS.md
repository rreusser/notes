...
- String parameters (`side`) use single-char Fortran convention in base.js; ndarray.js normalizes from stdlib full-word strings.

## Dependency Interface Surprises
- Dependencies: `reinterpret-complex128`, `zgemv`, `zgerc`. No unexpected interface issues encountered.
...
- All parameter combinations for `side` should be tested to ensure full branch coverage.
