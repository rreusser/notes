...
#### dtfttp.ndarray( transr, uplo, N, ARF, strideARF, offsetARF, AP, strideAP, offsetAP )
...
-   `dtfttp()` corresponds to the [LAPACK][lapack] level routine [`dtfttp`][lapack-dtfttp].
...
[lapack-dtfttp]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dtfttp.html
