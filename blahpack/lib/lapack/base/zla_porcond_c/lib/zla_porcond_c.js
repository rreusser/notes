...
*/
function zla_porcond_c( order, uplo, N, A, LDA, AF, LDAF, c, strideC, capply, WORK, strideWORK, RWORK, strideRWORK ) { // eslint-disable-line max-len, max-params
	var saf1;
	var saf2;
	var sa1;
	var sa2;
	...
	return base( uplo, N, A, sa1, sa2, 0, AF, saf1, saf2, 0, c, strideC, 0, capply, WORK, strideWORK, 0, RWORK, strideRWORK, 0 ); // eslint-disable-line max-len
}
