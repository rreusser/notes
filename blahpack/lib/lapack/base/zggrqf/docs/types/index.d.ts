...
interface Routine {
	...
	* @returns result
	*/
	( M: number, p: number, N: number, A: Float64Array, LDA: number, TAUA: Float64Array, strideTAUA: number, B: Float64Array, LDB: number, TAUB: Float64Array, strideTAUB: number, WORK: Float64Array, strideWORK: number, lwork: number ): Float64Array;
