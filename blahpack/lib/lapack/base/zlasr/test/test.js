...
test( 'works with non-unit stride for c and s', function t() {
	...
	base( 'L', 'V', 'F', M, N, c, 2, 0, s, 2, 0, A, 2, 2 * LDA, 0 );
...
test( 'accepts lowercase side, pivot, direct', function t() {
	...
	base( 'L', 'V', 'F', M, N, c, 1, 0, s, 1, 0, A1, 2, 2 * LDA, 0 );
	base( 'l', 'v', 'f', M, N, c, 1, 0, s, 1, 0, A2, 2, 2 * LDA, 0 );
...
test( 'returns A', function t() {
	...
	var c = new Float64Array( [ 1 ] );
	var s = new Float64Array( [ 0 ] );
	var result = base( 'L', 'V', 'F', 2, 2, c, 1, 0, s, 1, 0, A, 2, 4, 0 );
