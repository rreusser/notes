...
* @throws {RangeError} LDQ must be greater than or equal to max(1,N/M)
* @throws {RangeError} LDC must be greater than or equal to max(1,N/M)
* @returns {integer} status code (0 = success)
*/
function zunm22( order, side, trans, M, N, n1, n2, Q, LDQ, C, LDC, WORK, strideWORK, lwork ) { // eslint-disable-line max-len, max-params
	var sq1;
	var sq2;
	var sc1;
	var sc2;
