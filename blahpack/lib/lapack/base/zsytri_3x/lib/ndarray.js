...
/**
* Computes the inverse of a complex symmetric indefinite matrix using the factorization produced by `zsytrf_rk` (worker routine called by `zsytri_3`), using alternative indexing semantics.
*
