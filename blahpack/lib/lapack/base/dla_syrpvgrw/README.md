...
#### dla_syrpvgrw.ndarray( uplo, N, info, A, strideA1, strideA2, offsetA, AF, strideAF1, strideAF2, offsetAF, IPIV, strideIPIV, offsetIPIV, WORK, strideWORK, offsetWORK )
...
-   `dla_syrpvgrw()` corresponds to the [LAPACK][lapack] level routine [`dla_syrpvgrw`][lapack-dla_syrpvgrw].
...
[lapack-dla_syrpvgrw]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dla_syrpvgrw.html
