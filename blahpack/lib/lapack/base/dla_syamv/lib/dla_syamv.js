...
/**
* Computes `y := alpha*|A|*|x| + beta*|y|` using a symmetric indefinite matrix to calculate error bounds.
*
...
*/
function dla_syamv( order, uplo, N, alpha, A, LDA, x, strideX, beta, y, strideY ) {
	var sa1;
	var sa2;
	var ox;
	var oy;
