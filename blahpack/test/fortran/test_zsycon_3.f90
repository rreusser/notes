program test_zsycon_3
  ...
  double precision :: A_r(2*NMAX*NMAX), E_r(2*NMAX), anorm, rcond, RWORK(NMAX)
  equivalence (A, A_r)
  equivalence (E, E_r)
  ...
  A(3,4) = (3.0d0, 0.0d0)
  A(4,4) = (8.0d0, -0.25d0)
  anorm = zlansy('1', 'U', n, A, NMAX, RWORK)
  call ZSYTRF_RK('U', n, A, NMAX, E, IPIV, FWORK, LWORK, INFO)
  call ZSYCON_3('U', n, A, NMAX, E, IPIV, anorm, rcond, WORK, INFO)
  ...
  A(4,3) = (3.0d0, 0.0d0)
  A(4,4) = (8.0d0, -0.25d0)
  anorm = zlansy('1', 'L', n, A, NMAX, RWORK)
  call ZSYTRF_RK('L', n, A, NMAX, E, IPIV, FWORK, LWORK, INFO)
  call ZSYCON_3('L', n, A, NMAX, E, IPIV, anorm, rcond, WORK, INFO)
  ...
  ! Test 3: 3x3 complex identity (upper)
  n = 3
  A = (0.0d0, 0.0d0)
  E = (0.0d0, 0.0d0)
  A(1,1) = (1.0d0, 0.0d0)
  ...
  ! Test 5: indefinite (upper, forces 2x2 pivots)
  n = 4
  A = (0.0d0, 0.0d0)
  E = (0.0d0, 0.0d0)
  A(1,1) = (0.0d0, 0.0d0)
  ...
  ! Test 6: N=0
  n = 0
  call ZSYCON_3('U', n, A, NMAX, E, IPIV, 0.0d0, rcond, WORK, INFO)
