program test_dlarscl2
  ...
  d(2) = 20.0d0
  d(3) = 30.0d0
  call dlarscl2(3, 2, d, x, 3)
  call begin_test('rect_3x2')
  call print_array('x', x, 6)
  call end_test()

  ! Test 7: with negative values in D
  x(1) = 1.0d0; x(2) = 2.0d0; x(3) = 3.0d0; x(4) = 4.0d0
  d(1) = -1.0d0
  d(2) = 0.5d0
  call dlarscl2(2, 2, d, x, 2)
  call begin_test('negative_d')
