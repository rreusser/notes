program test_zhetri_3x
  ...
  ! Test 1: 4x4 upper Hermitian positive-definite-ish (1x1 pivots only), nb=2
  n = 4
  A = (0.0d0, 0.0d0)
  A(1,1) = (4.0d0, 0.0d0)
  ...
  nb = 2
  call ZHETRI_3X('U', n, A, NMAX, E, IPIV, WORK_3X, nb, INFO)
  call print_int('info', INFO)
  call print_array('a_inv', A_r, 2*NMAX*n)
  call end_test()

  ! Test 2: 4x4 lower Hermitian positive-definite-ish (1x1 pivots), nb=2
  n = 4
  A = (0.0d0, 0.0d0)
  A(1,1) = (4.0d0, 0.0d0)
  ...
  call print_int_array('ipiv', IPIV, n)
  nb = 2
  call ZHETRI_3X('L', n, A, NMAX, E, IPIV, WORK_3X, nb, INFO)
  call print_int('info', INFO)
  call print_array('a_inv', A_r, 2*NMAX*n)
  call end_test()

  ! Test 3: 4x4 upper indefinite (forces 2x2 pivots), nb=2. Zero diagonal drives 2x2 selection.
  n = 4
  A = (0.0d0, 0.0d0)
  A(1,1) = (0.0d0, 0.0d0)
