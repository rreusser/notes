program test_zhemm
  ...
  ! A is 3x3 Hermitian (upper stored), B is 3x2, C is 3x2
  ! A = [2 1+i 3-2i; 1-i 4 2+i; 3+2i 2-i 5]
  ! Upper: A(1,1)=2, A(1,2)=1+i, A(1,3)=3-2i, A(2,2)=4, A(2,3)=2+i, A(3,3)=5
  ! (diagonal is real)
  a = (0.0d0, 0.0d0)
  a(1) = (2.0d0, 0.0d0)   ! A(1,1)
  a(4) = (1.0d0, 1.0d0)   ! A(1,2)
  a(5) = (4.0d0, 0.0d0)   ! A(2,2)
  a(7) = (3.0d0, -2.0d0)  ! A(1,3)
  a(8) = (2.0d0, 1.0d0)   ! A(2,3)
  a(9) = (5.0d0, 0.0d0)   ! A(3,3)
  ...
  c = (0.0d0, 0.0d0)
  call zhemm('L', 'U', 3, 2, (1.0d0,0.0d0), a, 3, b, 3, (0.0d0,0.0d0), c, 3)
  call begin_test('left_upper_basic')
  call print_array('C', c_r, 12)
  call end_test()

  ! Test 2: SIDE='L', UPLO='L', same Hermitian matrix stored in lower triangle
  a = (0.0d0, 0.0d0)
  a(1) = (2.0d0, 0.0d0)   ! A(1,1)
  a(2) = (1.0d0, -1.0d0)  ! A(2,1) = conj(A(1,2))
  a(3) = (3.0d0, 2.0d0)   ! A(3,1) = conj(A(1,3))
  a(5) = (4.0d0, 0.0d0)   ! A(2,2)
  a(6) = (2.0d0, -1.0d0)  ! A(3,2) = conj(A(2,3))
  a(9) = (5.0d0, 0.0d0)   ! A(3,3)

  c = (0.0d0, 0.0d0)
  call zhemm('L', 'L', 3, 2, (1.0d0,0.0d0), a, 3, b, 3, (0.0d0,0.0d0), c, 3)
  call begin_test('left_lower_basic')
  call print_array('C', c_r, 12)
  call end_test()

  ! Test 3: SIDE='R', UPLO='U', M=2, N=3
  ! B is 2x3, A is 3x3 Hermitian (upper)
  a = (0.0d0, 0.0d0)
  a(1) = (2.0d0, 0.0d0); a(4) = (1.0d0, 1.0d0); a(5) = (4.0d0, 0.0d0)
  ...
  c = (0.0d0, 0.0d0)
  call zhemm('R', 'U', 2, 3, (1.0d0,0.0d0), a, 3, b, 2, (0.0d0,0.0d0), c, 2)
  ...
  a = (0.0d0, 0.0d0)
  a(1) = (2.0d0, 0.0d0); a(2) = (1.0d0, -1.0d0); a(3) = (3.0d0, 2.0d0)
  a(5) = (4.0d0, 0.0d0); a(6) = (2.0d0, -1.0d0); a(9) = (5.0d0, 0.0d0)

  c = (0.0d0, 0.0d0)
  call zhemm('R', 'L', 2, 3, (1.0d0,0.0d0), a, 3, b, 2, (0.0d0,0.0d0), c, 2)
  ...
  call zhemm('L', 'U', 3, 2, (2.0d0,1.0d0), a, 3, b, 3, (0.5d0,-0.5d0), c, 3)
  ...
  call zhemm('L', 'U', 2, 2, (0.0d0,0.0d0), a, 3, b, 2, (2.0d0,0.0d0), c, 2)
  ...
  c(1) = (99.0d0, 0.0d0)
  call zhemm('L', 'U', 0, 2, (1.0d0,0.0d0), a, 1, b, 1, (0.0d0,0.0d0), c, 1)
  ...
  c(1) = (99.0d0, 0.0d0)
  call zhemm('L', 'U', 2, 0, (1.0d0,0.0d0), a, 2, b, 2, (0.0d0,0.0d0), c, 2)
  ...
  a(1) = (3.0d0, 0.0d0)
  b(1) = (5.0d0, 2.0d0)
  call zhemm('L', 'U', 1, 1, (2.0d0,1.0d0), a, 1, b, 1, (0.0d0,0.0d0), c, 1)
  ...
  a = (0.0d0, 0.0d0)
  a(1) = (1.0d0, 0.0d0); a(3) = (0.0d0, 0.0d0)
  a(4) = (1.0d0, 0.0d0)
  b = (0.0d0, 0.0d0)
  b(1) = (2.0d0, 1.0d0); b(2) = (3.0d0, -1.0d0)
  b(3) = (4.0d0, 0.5d0); b(4) = (5.0d0, 2.0d0)
  call zhemm('L', 'L', 2, 2, (1.0d0,0.0d0), a, 2, b, 2, (0.0d0,0.0d0), c, 2)
  ...
  call zhemm('L', 'U', 2, 2, (0.0d0,0.0d0), a, 2, b, 2, (0.0d0,0.0d0), c, 2)
  call begin_test('alpha_zero_beta_zero')
  call print_array('C', c_r, 8)
  call end_test()

  ! Test 12: SIDE='L', UPLO='L', nonzero beta
  ! This covers left/lower with beta != 0 path (lines 239-243 in JS)
  a = (0.0d0, 0.0d0)
  a(1) = (2.0d0, 0.0d0)   ! A(1,1)
  a(2) = (1.0d0, -1.0d0)  ! A(2,1) = conj(A(1,2))
  a(3) = (3.0d0, 2.0d0)   ! A(3,1) = conj(A(1,3))
  ...
  c(1) = (1.0d0, 1.0d0); c(2) = (2.0d0, -1.0d0); c(3) = (0.5d0, 0.5d0)
  c(4) = (1.0d0, 0.0d0); c(5) = (0.0d0, 2.0d0);  c(6) = (3.0d0, -1.0d0)
  call zhemm('L', 'L', 3, 2, (1.0d0,0.0d0), a, 3, b, 3, (0.5d0,0.0d0), c, 3)
  call begin_test('left_lower_nonzero_beta')
  call print_array('C', c_r, 12)
  call end_test()

  ! Test 13: SIDE='R', UPLO='U', nonzero beta
  ! This covers right side with beta != 0 on the diagonal (lines 267-278 in JS)
  a = (0.0d0, 0.0d0)
  a(1) = (2.0d0, 0.0d0); a(4) = (1.0d0, 1.0d0); a(5) = (4.0d0, 0.0d0)
  a(7) = (3.0d0, -2.0d0); a(8) = (2.0d0, 1.0d0); a(9) = (5.0d0, 0.0d0)
  ...
  call zhemm('R', 'U', 2, 3, (1.0d0,0.0d0), a, 3, b, 2, (0.5d0,0.5d0), c, 2)
