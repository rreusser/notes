program test_dgeqrfp
  ...
  call DGEQRFP(3, 3, A, 70, TAU, WORK, 10000, INFO)
  call begin_test('3x3')
  ...
  TAU = 0.0d0; WORK = 0.0d0
  call DGEQRFP(4, 3, A, 70, TAU, WORK, 10000, INFO)
  call begin_test('4x3')
  ...
  A = 0.0d0
  TAU = 0.0d0; WORK = 0.0d0
  call DGEQRFP(3, 0, A, 70, TAU, WORK, 10000, INFO)
  call begin_test('n_zero')
  call print_int('INFO', INFO)
  call end_test()

  ! Test 4: Large matrix for blocked path (65x65)
  M = 65
  N = 65
  A = 0.0d0
  do j = 1, N
  ...
  TAU = 0.0d0; WORK = 0.0d0
  call DGEQRFP(M, N, A, 70, TAU, WORK, 10000, INFO)
