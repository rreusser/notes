program test_dgeqr2p
  ...
  call DGEQR2P(3, 2, A, 4, TAU, WORK, INFO)
  call begin_test('3x2')
  ...
  TAU = 0.0d0; WORK = 0.0d0
  call DGEQR2P(2, 2, A, 4, TAU, WORK, INFO)
  call begin_test('2x2')
  ...
  TAU = 0.0d0; WORK = 0.0d0
  call DGEQR2P(2, 0, A, 4, TAU, WORK, INFO)
  ...
  ! Test 4: M=0
  TAU = 0.0d0; WORK = 0.0d0
  call DGEQR2P(0, 2, A, 4, TAU, WORK, INFO)
  call begin_test('m_zero')
  call print_int('INFO', INFO)
  call end_test()

  ! Test 5: 4x3 matrix (well-conditioned)
  A = 0.0d0
  ...
  TAU = 0.0d0; WORK = 0.0d0
  call DGEQR2P(4, 3, A, 4, TAU, WORK, INFO)
  call begin_test('4x3')
  ...
  ! Test 6: 3x4 matrix (wide)
  A = 0.0d0
  A(1,1) = 1.0d0; A(1,2) = 2.0d0; A(1,3) = 3.0d0; A(1,4) = 4.0d0
  A(2,1) = 5.0d0; A(2,2) = 6.0d0; A(2,3) = 7.0d0; A(2,4) = 8.0d0
  A(3,1) = 9.0d0; A(3,2) = 1.0d0; A(3,3) = 2.0d0; A(3,4) = 3.0d0
  TAU = 0.0d0; WORK = 0.0d0
  call DGEQR2P(3, 4, A, 4, TAU, WORK, INFO)
  call begin_test('3x4')
  call print_matrix('A', A, 4, 3, 4)
  call print_array('TAU', TAU, 3)
  call print_int('INFO', INFO)
  call end_test()
