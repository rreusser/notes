program test_dsytri2x
  use test_utils
  implicit none
  double precision :: a(100), work_tf(200), work_2x(2000)
  double precision :: afact(100)
  integer :: ipiv(10), info, nb

  ! Test 1: 4x4 definite-like, UPLO='L' (1x1 pivots)
  a = 0.0d0
  ...
  call dsytrf('L', 4, a, 4, ipiv, work_tf, 200, info)
  afact(1:16) = a(1:16)
  nb = 2
  call dsytri2x('L', 4, a, 4, ipiv, work_2x, nb, info)
  ...
  call dsytrf('U', 4, a, 4, ipiv, work_tf, 200, info)
  afact(1:16) = a(1:16)
  nb = 2
  call dsytri2x('U', 4, a, 4, ipiv, work_2x, nb, info)
  ...
  ! Test 3: 4x4 indefinite, UPLO='L' (forces 2x2 pivots)
  a = 0.0d0
  ...
  call dsytrf('L', 5, a, 5, ipiv, work_tf, 200, info)
  afact(1:25) = a(1:25)
  nb = 2
  call dsytri2x('L', 5, a, 5, ipiv, work_2x, nb, info)
  ...
  call dsytrf('U', 5, a, 5, ipiv, work_tf, 200, info)
  afact(1:25) = a(1:25)
  nb = 2
  call dsytri2x('U', 5, a, 5, ipiv, work_2x, nb, info)
  ...
  ! Test 7: 5x5 lower, nb=3 (NNB+1 path)
  a = 0.0d0
  a(1) = 1.0d0; a(2) = -2.0d0; a(3) = 0.0d0; a(4) = 3.0d0; a(5) = 1.0d0
  a(6) = 0.0d0; a(7) = 0.0d0; a(8) = 4.0d0; a(9) = -1.0d0; a(10) = 2.0d0
  a(11) = 0.0d0; a(12) = 0.0d0; a(13) = -3.0d0; a(14) = 2.0d0; a(15) = 0.0d0
  ...
  ipiv(1) = 1
  nb = 2
  call dsytri2x('L', 1, a, 1, ipiv, work_2x, nb, info)
  call begin_test('n_one_lower')
  call print_array('a_inv', a, 1)
  call print_int('info', info)
  call end_test()

  ! Test 9: 6x6 lower, nb=4 (larger block)
  a = 0.0d0
  ...
  a(36) = 9.0d0
  call dsytrf('L', 6, a, 6, ipiv, work_tf, 200, info)
  afact(1:36) = a(1:36)
  nb = 4
  call dsytri2x('L', 6, a, 6, ipiv, work_2x, nb, info)
