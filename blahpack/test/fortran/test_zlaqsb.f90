program test_zlaqsb
  ...
  ! Complex band upper: AB(KD+1+i-j, j) = A(i,j) for max(1,j-KD)<=i<=j
  n = 4
  kd = 1
  ab = (0.0d0, 0.0d0)
  ! Diagonal: AB(KD+1, j) = A(j,j) — real diagonal for Hermitian
  ab(2, 1) = (4.0d0, 0.0d0)
  ab(2, 2) = (9.0d0, 0.0d0)
  ab(2, 3) = (16.0d0, 0.0d0)
  ab(2, 4) = (25.0d0, 0.0d0)
  ! Superdiagonal: AB(KD, j) = A(j-1,j) for j=2..N (complex off-diagonal)
  ab(1, 2) = (1.0d0, 2.0d0)
  ab(1, 3) = (3.0d0, 4.0d0)
  ab(1, 4) = (5.0d0, 6.0d0)
  ...
  scond = 0.02d0
  amax = 25.0d0
  call zlaqsb('U', n, kd, ab, LDAB, s, scond, amax, equed)
  ...
  scond = 0.02d0
  amax = 25.0d0
  call zlaqsb('L', n, kd, ab, LDAB, s, scond, amax, equed)
  ...
  kd = 1
  ab = (0.0d0, 0.0d0)
  ab(2, 1) = (1.0d-300, 0.0d0)
  ab(1, 2) = (0.0d0, 0.0d0)
  ab(2, 2) = (1.0d-300, 0.0d0)
  ...
  kd = 1
  ab = (0.0d0, 0.0d0)
  ab(2, 1) = (1.0d300, 0.0d0)
  ab(1, 2) = (0.0d0, 0.0d0)
  ab(2, 2) = (1.0d300, 0.0d0)
