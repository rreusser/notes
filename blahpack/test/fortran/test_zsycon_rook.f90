program test_zsycon_rook
  ...
  double precision, external :: zlansy

  LWORK = NMAX * 32

  ! Test 1: 4x4 complex symmetric (upper)
  n = 4
  A = (0.0d0, 0.0d0)
  A(1,1) = (4.0d0, 1.0d0)
  A(1,2) = (1.0d0, 2.0d0)
  ...
  A(3,4) = (3.0d0, 0.0d0)
  A(4,4) = (8.0d0, 1.0d0)
  anorm = zlansy('1', 'U', n, A, NMAX, W_r)
  call ZSYTRF_ROOK('U', n, A, NMAX, IPIV, WORK, LWORK, INFO)
  call ZSYCON_ROOK('U', n, A, NMAX, IPIV, anorm, rcond, WORK, INFO)
  ...
  ! Test 2: 4x4 complex symmetric (lower)
  n = 4
  A = (0.0d0, 0.0d0)
  A(1,1) = (4.0d0, 1.0d0)
  A(2,1) = (1.0d0, 2.0d0)
  ...
  A(4,3) = (3.0d0, 0.0d0)
  A(4,4) = (8.0d0, 1.0d0)
  anorm = zlansy('1', 'L', n, A, NMAX, W_r)
  call ZSYTRF_ROOK('L', n, A, NMAX, IPIV, WORK, LWORK, INFO)
  call ZSYCON_ROOK('L', n, A, NMAX, IPIV, anorm, rcond, WORK, INFO)
  ...
  ! Test 5: 3x3 indefinite complex symmetric (lower) — exercises 2x2 pivots
  n = 3
  A = (0.0d0, 0.0d0)
  A(1,1) = (0.0d0, 0.0d0)
  A(2,1) = (1.0d0, 1.0d0)
