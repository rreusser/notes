program test_dpbtrs
  ...
  double precision :: ab(100), b(100), ab_save(100)
  ...
  ldb = 5
  ab = 0.0d0
  ! Upper band storage: row 0 = superdiag, row 1 = diag
  ab(1) = 0.0d0;  ab(2) = 2.0d0   ! col 1
  ab(3) = -1.0d0; ab(4) = 2.0d0   ! col 2
  ab(5) = -1.0d0; ab(6) = 2.0d0   ! col 3
  ab(7) = -1.0d0; ab(8) = 2.0d0   ! col 4
  ab(9) = -1.0d0; ab(10) = 2.0d0  ! col 5

  ! First factorize
  call dpbtrf('U', 5, 1, ab, ldab, info)
  ab_save(1:10) = ab(1:10)

  ! Set up RHS
  b(1) = 1.0d0; b(2) = 0.0d0; b(3) = 0.0d0; b(4) = 0.0d0; b(5) = 1.0d0

  ! Solve
  call dpbtrs('U', 5, 1, 1, ab, ldab, b, ldb, info)
  ...
  ldb = 5
  ab = 0.0d0
  ! Lower band storage: row 0 = diag, row 1 = subdiag
  ab(1) = 2.0d0;  ab(2) = -1.0d0   ! col 1
  ab(3) = 2.0d0;  ab(4) = -1.0d0   ! col 2
  ab(5) = 2.0d0;  ab(6) = -1.0d0   ! col 3
  ab(7) = 2.0d0;  ab(8) = -1.0d0   ! col 4
  ab(9) = 2.0d0;  ab(10) = 0.0d0   ! col 5

  call dpbtrf('L', 5, 1, ab, ldab, info)

  b(1) = 1.0d0; b(2) = 0.0d0; b(3) = 0.0d0; b(4) = 0.0d0; b(5) = 1.0d0

  call dpbtrs('L', 5, 1, 1, ab, ldab, b, ldb, info)
  call begin_test('lower_tridiag_nrhs1')
  call print_int('info', info)
  call print_array('x', b, 5)
  call end_test()

  ! ===== Test 3: UPLO='U', N=5, KD=1 (tridiagonal), NRHS=2 =====
  ldab = 2
  ldb = 5
  ab = 0.0d0
  ...
  call dpbtrs('U', 5, 1, 2, ab, ldab, b, ldb, info)
  ...
  call dpbtrs('U', 0, 0, 1, ab, 1, b, 1, info)
  call begin_test('n_zero')
  call print_int('info', info)
  call end_test()

  ! ===== Test 5: NRHS=0 (quick return) =====
  call dpbtrs('L', 5, 1, 0, ab, 2, b, 5, info)
  call begin_test('nrhs_zero')
  call print_int('info', info)
  call end_test()

  ! ===== Test 6: N=1, KD=0 =====
  ab(1) = 2.0d0  ! diagonal only, already factored: sqrt(4)=2
  b(1) = 6.0d0
  call dpbtrs('U', 1, 0, 1, ab, 1, b, 1, info)
  call begin_test('n_one')
  call print_int('info', info)
  call print_array('x', b, 1)
  call end_test()

  ! ===== Test 7: UPLO='U', N=4, KD=2 (pentadiagonal), NRHS=1 =====
  ldab = 3
  ldb = 4
  ab = 0.0d0
  ! Diag-dominant SPD: diag=6, 1st super=-1, 2nd super=0.5
  ...
  call dpbtrs('U', 4, 2, 1, ab, ldab, b, ldb, info)
  ...
  call dpbtrs('L', 4, 2, 1, ab, ldab, b, ldb, info)
  call begin_test('lower_penta_nrhs1')
  call print_int('info', info)
  call print_array('x', b, 4)
  call end_test()

  ! ===== Test 9: UPLO='L', N=4, KD=2, NRHS=3 (multiple RHS) =====
  ldab = 3
  ldb = 4
  ab = 0.0d0
  ab(1) = 6.0d0; ab(2) = -1.0d0; ab(3) = 0.5d0
  ...
  b(1) = 1.0d0; b(2) = 0.0d0; b(3) = 0.0d0; b(4) = 0.0d0
  b(5) = 0.0d0; b(6) = 1.0d0; b(7) = 0.0d0; b(8) = 0.0d0
  b(9) = 0.0d0; b(10) = 0.0d0; b(11) = 1.0d0; b(12) = 0.0d0

  call dpbtrs('L', 4, 2, 3, ab, ldab, b, ldb, info)
  call begin_test('lower_penta_nrhs3')
  call print_int('info', info)
  call print_array('x', b, 12)
  call end_test()
