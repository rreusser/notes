program test_zgehd2
  ...
  integer :: INFO, N, LDA
  double precision :: a_r(200), tau_r(20), work_r(200)
  complex*16 :: A(100), TAU(10), WORK(100)
  equivalence (A, a_r)
  ...
  TAU = (0.0d0, 0.0d0)
  WORK = (0.0d0, 0.0d0)
  call ZGEHD2(N, 1, N, A, LDA, TAU, WORK, INFO)
  ...
  ! Test 3: 4x4 partial range (ILO=2, IHI=3)
  N = 4
  LDA = 4
  A = (0.0d0, 0.0d0)
  ...
  TAU = (0.0d0, 0.0d0)
  WORK = (0.0d0, 0.0d0)
  call ZGEHD2(N, 2, 3, A, LDA, TAU, WORK, INFO)
  ...
  ! Test 4: N=1 (quick return, no TAU entries)
  N = 1
  LDA = 1
  A(1) = (42.0d0, 3.0d0)
  TAU = (0.0d0, 0.0d0)
  WORK = (0.0d0, 0.0d0)
  call ZGEHD2(N, 1, 1, A, LDA, TAU, WORK, INFO)
  ...
  ! Test 6: 6x6 full range (larger test)
  N = 6
  LDA = 6
  A = (0.0d0, 0.0d0)
