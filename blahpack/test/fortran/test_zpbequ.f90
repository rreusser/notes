program test_zpbequ
  ...
  ! Band storage: LDAB = KD+1 rows, N columns (complex)
  ! Upper: AB(KD+1+i-j, j) = A(i,j) => diagonal at row KD+1
  ! Lower: AB(1+i-j, j) = A(i,j) => diagonal at row 1
  ! ZPBEQU only reads DBLE(AB(diag_row, j)) for each column j
  ...
  ! Diagonal (real parts): 4.0, 9.0, 16.0, 25.0
  ...
  ab(8) = (2.0d0, 1.0d0)
  ab(9) = (16.0d0, 0.0d0)
  ! Col 4: row2=superdiag, row3=diag
  ab(11) = (1.5d0, 0.2d0)
  ab(12) = (25.0d0, 0.0d0)

  call zpbequ('U', 4, 2, ab, ldab, s, scond, amax, info)
  ...
  ! Test 2: UPLO='L', N=4, KD=2, same diagonal values
  ...
  call zpbequ('L', 4, 2, ab, ldab, s, scond, amax, info)
  ...
  call zpbequ('U', 0, 0, ab, 1, s, scond, amax, info)
  ...
  ldab = 1
  ab(1) = (49.0d0, 0.0d0)
  call zpbequ('U', 1, 0, ab, ldab, s, scond, amax, info)
  ...
  call zpbequ('U', 3, 1, ab, ldab, s, scond, amax, info)
  ...
  call zpbequ('L', 3, 1, ab, ldab, s, scond, amax, info)
  ...
  ldab = 2
  ab = (0.0d0, 0.0d0)
  ab(2) = (1.0d0, 0.0d0)  ! Col 1 diag
  ab(4) = (1.0d0, 0.0d0)  ! Col 2 diag
  ab(6) = (1.0d0, 0.0d0)  ! Col 3 diag
  ...
  call zpbequ('L', 3, 0, ab, ldab, s, scond, amax, info)
  ...
  call zpbequ('U', 3, 0, ab, ldab, s, scond, amax, info)
