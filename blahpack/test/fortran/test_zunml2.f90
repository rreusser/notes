program test_zunml2
  ...
  call zunml2('L', 'N', 5, 5, 3, A, 6, TAU, C, 6, WORK, info)
  ...
  call zunml2('L', 'C', 5, 5, 3, A, 6, TAU, C, 6, WORK, info)
  ...
  call zunml2('R', 'N', 5, 5, 3, A, 6, TAU, C, 6, WORK, info)
  ...
  call zunml2('L', 'N', 0, 5, 0, A, 6, TAU, C, 6, WORK, info)
  call begin_test('m_zero')
  call print_int('info', info)
  call end_test()

  ! Test 5: N=0 quick return
  call zunml2('L', 'N', 5, 0, 0, A, 6, TAU, C, 6, WORK, info)
  call begin_test('n_zero')
  call print_int('info', info)
  call end_test()

  ! Test 6: K=0 quick return
  call zunml2('L', 'N', 5, 5, 0, A, 6, TAU, C, 6, WORK, info)
  call begin_test('k_zero')
  call print_int('info', info)
  call end_test()

  ! Test 7: Apply Q to non-identity matrix (right, conj trans)
  A = (0.0d0, 0.0d0)
  A(1,1) = (1.0d0, 0.0d0); A(1,2) = (2.0d0, 1.0d0); A(1,3) = (0.0d0, 0.0d0); A(1,4) = (1.0d0, 1.0d0); A(1,5) = (3.0d0, 0.0d0)
  A(2,1) = (0.0d0, 2.0d0); A(2,2) = (1.0d0, 0.0d0); A(2,3) = (3.0d0, 1.0d0); A(2,4) = (2.0d0, 0.0d0); A(2,5) = (1.0d0, 1.0d0)
  A(3,1) = (3.0d0, 1.0d0); A(3,2) = (0.0d0, 0.0d0); A(3,3) = (1.0d0, 0.0d0); A(3,4) = (2.0d0, 1.0d0); A(3,5) = (0.0d0, 2.0d0)
  ...
  call zunml2('R', 'C', 3, 5, 3, A, 6, TAU, C, 6, WORK, info)
