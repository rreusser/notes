program test_zsytri_rook
  ...
  n = 0
  info = -999
  call zsytri_rook('U', n, a, lda, ipiv, work, info)
  call begin_test('n0')
  ...
  a = (0.0d0, 0.0d0)
  a(1,1) = (4.0d0, 1.0d0)
  call zsytf2_rook('U', n, a, lda, ipiv, info)
  ...
  a = (0.0d0, 0.0d0)
  a(1,1) = (9.0d0, -2.0d0)
  call zsytf2_rook('L', n, a, lda, ipiv, info)
  call begin_test('n1_lower_factored')
  call print_array('a', a_r, 2*n*n)
  call print_int_array('ipiv', ipiv, n)
  call end_test()
  call zsytri_rook('L', n, a, lda, ipiv, work, info)
  call begin_test('n1_lower')
  call print_array('a', a_r, 2*n*n)
  call print_int('info', info)
  call end_test()

  ! Test 4: 3x3 upper complex symmetric
  n = 3
  a = (0.0d0, 0.0d0)
  a(1,1) = (4.0d0, 1.0d0)
  a(1,2) = (1.0d0, 2.0d0)
