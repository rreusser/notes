program test_zgetf2
  ...
  ! Test 2: 4x4 well-conditioned complex matrix
  a = (0.0d0, 0.0d0)
  ...
  ipiv = 0
  call zgetf2(4, 3, a, 4, ipiv, info)
  call begin_test('4x3_tall')
  call print_array('a', a_r, 24)
  call print_int_array('ipiv', ipiv, 3)
  call print_int('info', info)
  call end_test()

  ! Test 4: 3x4 wide matrix (N > M)
  a = (0.0d0, 0.0d0)
  a(1) = (1.0d0, 0.5d0); a(2) = (3.0d0, 1.0d0); a(3) = (2.0d0, 0.3d0)
  a(4) = (4.0d0, 2.0d0); a(5) = (1.0d0, 0.1d0); a(6) = (5.0d0, 1.5d0)
  a(7) = (2.0d0, 1.0d0); a(8) = (6.0d0, 3.0d0); a(9) = (3.0d0, 0.2d0)
  a(10) = (1.0d0, 0.0d0); a(11) = (2.0d0, 1.0d0); a(12) = (0.0d0, 0.5d0)
  ipiv = 0
  call zgetf2(3, 4, a, 3, ipiv, info)
  call begin_test('3x4_wide')
  call print_array('a', a_r, 24)
  call print_int_array('ipiv', ipiv, 3)
  call print_int('info', info)
  call end_test()
  ...
  call zgetf2(3, 0, a, 3, ipiv, info)
  call begin_test('n_zero')
  call print_int('info', info)
  call end_test()

  ! Test 7: M=0 quick return
  call zgetf2(0, 3, a, 1, ipiv, info)
