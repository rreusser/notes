program test_zgeqrf
  ...
  a(12) = (5.0d0, 6.0d0)
  tau = (0.0d0, 0.0d0)
  call zgeqrf(4, 3, a, 4, tau, work, lwork, info)
  ...
  a(9) = (2.0d0, 2.0d0)
  tau = (0.0d0, 0.0d0)
  call zgeqrf(3, 3, a, 3, tau, work, lwork, info)
  ...
  a = (0.0d0, 0.0d0)
  tau = (0.0d0, 0.0d0)
  call zgeqrf(0, 3, a, 1, tau, work, lwork, info)
  ...
  a = (0.0d0, 0.0d0)
  tau = (0.0d0, 0.0d0)
  call zgeqrf(4, 0, a, 4, tau, work, lwork, info)
  ...
  a(1) = (5.0d0, 3.0d0)
  tau = (0.0d0, 0.0d0)
  call zgeqrf(1, 1, a, 1, tau, work, lwork, info)
  ...
  ! Test 6: 5x2 tall-skinny (below NB, pure unblocked path)
  a = (0.0d0, 0.0d0)
  a(1) = (1.0d0, 0.5d0)
  a(2) = (2.0d0, 1.0d0)
  a(3) = (3.0d0, 1.5d0)
  ...
  a(10) = (4.5d0, 5.0d0)
  tau = (0.0d0, 0.0d0)
  call zgeqrf(5, 2, a, 5, tau, work, lwork, info)
  ...
  a(10) = (0.0d0, 1.0d0)
  tau = (0.0d0, 0.0d0)
  call zgeqrf(2, 5, a, 2, tau, work, lwork, info)
  ...
  ! Test 8: 40x35 large matrix (exercises blocked path with NB)
  ! A(i,j) = ((i*7 + j*13) mod 100) / 10 + ((i*11 + j*3) mod 100) / 10 * i_unit
  M = 40
  N = 35
  LDA = M
  a = (0.0d0, 0.0d0)
