program test_zhetf2
  ...
  ! Test 1: Upper, 4x4 Hermitian matrix (A = A^H, diagonal is real)
  n = 4
  A = (0.0d0, 0.0d0)
  A(1,1) = (4.0d0, 0.0d0)
  A(1,2) = (1.0d0, 2.0d0)
  ...
  A(3,4) = (3.0d0, 0.0d0)
  A(4,4) = (6.0d0, 0.0d0)
  call ZHETF2('U', n, A, NMAX, IPIV, INFO)
  ...
  A(4,3) = (3.0d0, 0.0d0)
  A(4,4) = (6.0d0, 0.0d0)
  call ZHETF2('L', n, A, NMAX, IPIV, INFO)
  ...
  ! Test 3: N=0
  call ZHETF2('U', 0, A, NMAX, IPIV, INFO)
  call begin_test('n0')
  call print_int('info', INFO)
  call end_test()
  ...
  ! Test 6: Lower, 6x6 to exercise 2x2 pivots (small diagonal forces pivoting)
  n = 6
  A = (0.0d0, 0.0d0)
  A(1,1) = (0.01d0, 0.0d0)
  A(2,1) = (5.0d0, -1.0d0)
