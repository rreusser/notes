program test_zhetri
  ...
  n = 0
  info = -999
  call zhetri('U', n, a, lda, ipiv, work, info)
  call begin_test('n0')
  ...
  a = (0.0d0, 0.0d0)
  a(1,1) = (4.0d0, 0.0d0)
  call zhetrf('U', n, a, lda, ipiv, work, n, info)
  ...
  a = (0.0d0, 0.0d0)
  a(1,1) = (9.0d0, 0.0d0)
  call zhetrf('L', n, a, lda, ipiv, work, n, info)
  call begin_test('n1_lower_factored')
  call print_array('a', a_r, 2*n*n)
  call print_int_array('ipiv', ipiv, n)
  call end_test()
  call zhetri('L', n, a, lda, ipiv, work, info)
