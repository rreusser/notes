program test_dgelq2
  ...
  ! Test 1: 3x4 matrix (M < N, well-conditioned, no rank deficiency)
  A = 0.0d0
  ...
  call DGELQ2(3, 4, A, 6, TAU, WORK, INFO)
  call begin_test('3x4')
  ...
  TAU = 0.0d0; WORK = 0.0d0
  call DGELQ2(4, 3, A, 6, TAU, WORK, INFO)
  call begin_test('4x3')
  ...
  TAU = 0.0d0; WORK = 0.0d0
  call DGELQ2(3, 3, A, 6, TAU, WORK, INFO)
  call begin_test('3x3')
  ...
  TAU = 0.0d0; WORK = 0.0d0
  call DGELQ2(1, 4, A, 6, TAU, WORK, INFO)
  call begin_test('1x4')
  ...
  A(3,1) = 4.0d0
  TAU = 0.0d0; WORK = 0.0d0
  call DGELQ2(3, 1, A, 6, TAU, WORK, INFO)
  call begin_test('3x1')
  ...
  TAU = 0.0d0; WORK = 0.0d0
  call DGELQ2(0, 3, A, 6, TAU, WORK, INFO)
  ...
  TAU = 0.0d0; WORK = 0.0d0
  call DGELQ2(3, 0, A, 6, TAU, WORK, INFO)
  ...
  A(1,1) = 7.0d0
  TAU = 0.0d0; WORK = 0.0d0
  call DGELQ2(1, 1, A, 6, TAU, WORK, INFO)
  call begin_test('1x1')
  ...
  TAU = 0.0d0; WORK = 0.0d0
  call DGELQ2(2, 5, A, 6, TAU, WORK, INFO)
  call begin_test('2x5')
