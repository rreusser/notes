program test_zhetri_3
  ...
  ! Test 1: 4x4 upper Hermitian definite (1x1 pivots)
  n = 4
  A = (0.0d0, 0.0d0)
  A(1,1) = (4.0d0, 0.0d0)
  ...
  call ZHETRF_RK('U', n, A, NMAX, E, IPIV, WORK_RK, LWORK_RK, INFO)
  ...
  call ZHETRI_3('U', n, A, NMAX, E, IPIV, WORK_3, LWORK, INFO)
  call print_int('info', INFO)
  call print_array('a_inv', A_r, 2*NMAX*n)
  call end_test()

  ! Test 2: 4x4 lower Hermitian definite
  n = 4
  A = (0.0d0, 0.0d0)
  A(1,1) = (4.0d0, 0.0d0)
  ...
  call ZHETRF_RK('L', n, A, NMAX, E, IPIV, WORK_RK, LWORK_RK, INFO)
  call begin_test('4x4_lower_def')
  call print_int('info_trf', INFO)
  call print_array('a_factored', A_r, 2*NMAX*n)
  call print_array('e', E_r, 2*n)
  call print_int_array('ipiv', IPIV, n)
  call ZHETRI_3('L', n, A, NMAX, E, IPIV, WORK_3, LWORK, INFO)
  call print_int('info', INFO)
  call print_array('a_inv', A_r, 2*NMAX*n)
  call end_test()

  ! Test 3: 5x5 indefinite upper (forces 2x2 pivots)
  n = 5
  A = (0.0d0, 0.0d0)
  A(1,1) = (0.0d0, 0.0d0)
  A(1,2) = (1.0d0, 1.0d0);   A(2,2) = (0.0d0, 0.0d0)
  A(1,3) = (2.0d0, -1.0d0);  A(2,3) = (3.0d0, 0.0d0);  A(3,3) = (1.0d0, 0.0d0)
  A(1,4) = (0.5d0, 0.0d0);   A(2,4) = (1.0d0, -2.0d0); A(3,4) = (2.0d0, 1.0d0);  A(4,4) = (2.0d0, 0.0d0)
  A(1,5) = (1.0d0, 0.5d0);   A(2,5) = (0.5d0, 1.0d0);  A(3,5) = (1.0d0, -1.0d0); A(4,5) = (3.0d0, 0.0d0); A(5,5) = (4.0d0, 0.0d0)
  call ZHETRF_RK('U', n, A, NMAX, E, IPIV, WORK_RK, LWORK_RK, INFO)
  ...
  E(1) = (0.0d0, 0.0d0)
  IPIV(1) = 1
  call ZHETRI_3('L', 1, A, NMAX, E, IPIV, WORK_3, LWORK, INFO)
  ...
  ! Test 5: N=0
  call ZHETRI_3('L', 0, A, NMAX, E, IPIV, WORK_3, LWORK, INFO)
  call begin_test('n_zero')
  call print_int('info', INFO)
  call end_test()

  ! Test 6: workspace query (LWORK=-1)
  call ZHETRI_3('L', 5, A, NMAX, E, IPIV, WORK_3, -1, INFO)
