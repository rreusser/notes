program test_dormr2
  ...
  TAU = 0.0d0
  call dgerq2(3, 4, A, 4, TAU, WORK, info)
  ...
  A = ASAVE; TAU = TAUSAVE
  call dormr2('L', 'N', 4, 4, 3, A, 4, TAU, C, 4, WORK, info)
  ...
  C(1,1) = 1.0d0; C(2,2) = 1.0d0; C(3,3) = 1.0d0; C(4,4) = 1.0d0
  A = ASAVE; TAU = TAUSAVE
  call dormr2('L', 'T', 4, 4, 3, A, 4, TAU, C, 4, WORK, info)
  ...
  C(1,1) = 1.0d0; C(2,2) = 1.0d0; C(3,3) = 1.0d0; C(4,4) = 1.0d0
  A = ASAVE; TAU = TAUSAVE
  call dormr2('R', 'N', 4, 4, 3, A, 4, TAU, C, 4, WORK, info)
  ...
  C(1,1) = 1.0d0; C(2,2) = 1.0d0; C(3,3) = 1.0d0; C(4,4) = 1.0d0
  A = ASAVE; TAU = TAUSAVE
  call dormr2('R', 'T', 4, 4, 3, A, 4, TAU, C, 4, WORK, info)
  ...
  call dormr2('L', 'N', 0, 4, 0, A, 1, TAU, C, 1, WORK, info)
  call begin_test('m_zero')
  call print_int('info', info)
  call end_test()

  ! Test 6: N=0 quick return
  call dormr2('L', 'N', 4, 0, 0, A, 4, TAU, C, 4, WORK, info)
  call begin_test('n_zero')
  call print_int('info', info)
  call end_test()

  ! Test 7: K=0 quick return
  call dormr2('L', 'N', 4, 4, 0, A, 4, TAU, C, 4, WORK, info)
  ...
  A = ASAVE; TAU = TAUSAVE
  call dormr2('L', 'N', 4, 2, 3, A, 4, TAU, C, 4, WORK, info)
  ...
  C(1,2) = 2.0d0; C(2,2) = 0.0d0; C(3,2) = 4.0d0; C(4,2) = -1.0d0
  A = ASAVE; TAU = TAUSAVE
  call dormr2('L', 'T', 4, 2, 3, A, 4, TAU, C, 4, WORK, info)
  ...
  A = ASAVE; TAU = TAUSAVE
  call dormr2('R', 'N', 2, 4, 3, A, 4, TAU, CR, 2, WORK, info)
  ...
  CR(1,4) = 4.0d0; CR(2,4) = -2.0d0
  A = ASAVE; TAU = TAUSAVE
  call dormr2('R', 'T', 2, 4, 3, A, 4, TAU, CR, 2, WORK, info)
  ...
  C(1,1) = 1.0d0; C(2,2) = 1.0d0; C(3,3) = 1.0d0; C(4,4) = 1.0d0
  A = ASAVE; TAU = TAUSAVE
  call dormr2('L', 'N', 4, 4, 1, A, 4, TAU, C, 4, WORK, info)
