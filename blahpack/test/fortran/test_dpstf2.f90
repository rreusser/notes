program test_dpstf2
  ...
  work = 0.0d0
  call dpstf2('U', 3, a, 3, piv, rank, -1.0d0, work, info)
  ...
  a(7) = 1.0d0; a(8) = 3.0d0; a(9) = 6.0d0
  work = 0.0d0
  call dpstf2('L', 3, a, 3, piv, rank, -1.0d0, work, info)
  ...
  ! A = [10 3 2 1; 3 8 4 2; 2 4 9 5; 1 2 5 7] (column-major)
  a = 0.0d0
  ...
  work = 0.0d0
  call dpstf2('U', 4, a, 4, piv, rank, -1.0d0, work, info)
  ...
  a(13) = 1.0d0; a(14) = 2.0d0; a(15) = 5.0d0; a(16) = 7.0d0
  work = 0.0d0
  call dpstf2('L', 4, a, 4, piv, rank, -1.0d0, work, info)
  ...
  ! Test 5: rank-deficient 3x3 (rank 2), upper
  ...
  ! Test 7: N=0
  call dpstf2('U', 0, a, 1, piv, rank, -1.0d0, work, info)
  ...
  a(1) = 9.0d0
  work = 0.0d0
  call dpstf2('U', 1, a, 1, piv, rank, -1.0d0, work, info)
