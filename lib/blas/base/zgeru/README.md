...
zgeru.ndarray( 2, 2, alpha, x, 1, 0, y, 1, 0, A, 2, 1, 0 );
```
...
-   `zgeru()` corresponds to the [LAPACK][lapack] level routine [`zgeru`][lapack-zgeru].
...
[lapack-zgeru]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zgeru.html
