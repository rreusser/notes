...
- String parameters (`diag`, `side`, `transa`, `uplo`) use single-char Fortran convention in base.js; ndarray.js normalizes from stdlib full-word strings.
...
- All parameter combinations for `diag`, `side`, `transa`, `uplo` should be tested to ensure full branch coverage.
