...
#### dtbmv( order, uplo, trans, diag, N, K, A, LDA, x, strideX )
...
#### dtbmv.ndarray( uplo, trans, diag, N, K, A, strideA1, strideA2, offsetA, x, strideX, offsetX )
...
-   `dtbmv()` corresponds to the [LAPACK][lapack] level routine [`dtbmv`][lapack-dtbmv].
...
[lapack-dtbmv]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dtbmv.html
