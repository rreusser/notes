...
dtrsv.ndarray( 'upper', 'no-transpose', 'non-unit', 2, A, 2, 1, 0, x, 1, 0 );
```
...
-   `dtrsv()` corresponds to the [LAPACK][lapack] level routine [`dtrsv`][lapack-dtrsv].
...
[lapack-dtrsv]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dtrsv.html
