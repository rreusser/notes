...
dsymv.ndarray( 'upper', 2, 1.0, A, 2, 1, 0, x, 1, 0, 0.0, y, 1, 0 );
```
...
-   `dsymv()` corresponds to the [LAPACK][lapack] level routine [`dsymv`][lapack-dsymv].
...
[lapack-dsymv]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dsymv.html
