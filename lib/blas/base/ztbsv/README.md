...
ztbsv.ndarray( 'upper', 'no-transpose', 'non-unit', 2, 1, A, 2, 1, 0, x, 1, 0 );
```
...
-   `ztbsv()` corresponds to the [LAPACK][lapack] level routine [`ztbsv`][lapack-ztbsv].
...
[lapack-ztbsv]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__ztbsv.html
