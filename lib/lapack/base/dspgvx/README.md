...
-   `dspgvx()` corresponds to the [LAPACK][lapack] level routine [`dspgvx`][lapack-dspgvx].
...
[lapack-dspgvx]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dspgvx.html
