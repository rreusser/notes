...
function createBenchmark( len ) {
	...
	X1 = uniform( M, -10.0, 10.0, options );
	X2 = uniform( M, -10.0, 10.0, options );
	Q1 = uniform( M * N, -10.0, 10.0, options );
	Q2 = uniform( M * N, -10.0, 10.0, options );
	...
	*/
	function benchmark( b ) {
		...
		for ( i = 0; i < b.iterations; i++ ) {
			y = dorbdb5( M, M, N, X1, 1, 0, X2, 1, 0, Q1, 1, M, 0, Q2, 1, M, 0, WORK, 1, 0 );
			if ( isnan( y ) ) {
