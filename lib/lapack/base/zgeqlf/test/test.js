...
test( 'main export and ndarray method are distinct functions', function t() {
	assert.notStrictEqual( zgeqlf, zgeqlf.ndarray, 'are distinct' );
	assert.strictEqual( typeof zgeqlf.ndarray, 'function', 'ndarray is a function' ); // eslint-disable-line max-len
});
