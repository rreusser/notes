...
var out = ztrsen( 'both', 'update', SELECT, 1, N, T, N, Q, N, W, 1, N, 1.0, 1, WORK, 1, N );
console.log( out );

// Using the ndarray interface:
out = ztrsen.ndarray( 'both', 'update', SELECT, 1, 0, N, T, N, 1, 0, Q, N, 1, 0, W, 1, 0, N, 1.0, 1, WORK, 1, 0, N );
console.log( out );
