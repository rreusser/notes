...
zpotf2.ndarray( 'upper', N, A, N, 1, 0 );
```
...
-   `zpotf2()` corresponds to the [LAPACK][lapack] level routine [`zpotf2`][lapack-zpotf2].
...
[lapack-zpotf2]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zpotf2.html
