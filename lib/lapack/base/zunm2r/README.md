...
zunm2r.ndarray( 'left', 'no-transpose', N, N, N, A, N, 1, 0, TAU, 1, 0, C, N, 1, 0, WORK, 1, 0 );
```
...
-   `zunm2r()` corresponds to the [LAPACK][lapack] level routine [`zunm2r`][lapack-zunm2r].
...
[lapack-zunm2r]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zunm2r.html
