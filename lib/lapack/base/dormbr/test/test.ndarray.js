...
test( 'dormbr: VECT=Q, SIDE=L, TRANS=N (upper bidiagonal, NQ>=K)', function t() { // eslint-disable-line max-len
	...
	info = dormbr('q', 'left', 'no-transpose', 4, 4, 3, A, 1, 4, 0, TAUQ, 1, 0, C, 1, 4, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0 );
...
test( 'dormbr: VECT=Q, SIDE=L, TRANS=T (upper bidiagonal)', function t() {
	...
	C = eye( 4, 4 );
	WORK = new Float64Array( 1000 );
	info = dormbr('q', 'left', 'transpose', 4, 4, 3, A, 1, 4, 0, TAUQ, 1, 0, C, 1, 4, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=P, SIDE=R, TRANS=N (upper bidiagonal, NQ>=K)', function t() { // eslint-disable-line max-len
	...
	C = eye( 3, 3 );
	WORK = new Float64Array( 1000 );
	info = dormbr('p', 'right', 'no-transpose', 3, 3, 3, A, 1, 4, 0, TAUP, 1, 0, C, 1, 3, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=P, SIDE=R, TRANS=T (upper bidiagonal)', function t() {
	...
	C = eye( 3, 3 );
	WORK = new Float64Array( 1000 );
	info = dormbr('p', 'right', 'transpose', 3, 3, 3, A, 1, 4, 0, TAUP, 1, 0, C, 1, 3, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=Q, SIDE=R, TRANS=N (upper bidiagonal)', function t() {
	...
	C = eye( 4, 4 );
	WORK = new Float64Array( 1000 );
	info = dormbr('q', 'right', 'no-transpose', 4, 4, 3, A, 1, 4, 0, TAUQ, 1, 0, C, 1, 4, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=P, SIDE=L, TRANS=N (upper bidiagonal)', function t() {
	...
	C = eye( 3, 3 );
	WORK = new Float64Array( 1000 );
	info = dormbr('p', 'left', 'no-transpose', 3, 3, 3, A, 1, 4, 0, TAUP, 1, 0, C, 1, 3, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=Q, SIDE=R, TRANS=T (upper bidiagonal)', function t() {
	...
	C = eye( 4, 4 );
	WORK = new Float64Array( 1000 );
	info = dormbr('q', 'right', 'transpose', 4, 4, 3, A, 1, 4, 0, TAUQ, 1, 0, C, 1, 4, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=P, SIDE=L, TRANS=T (upper bidiagonal)', function t() {
	...
	C = eye( 3, 3 );
	WORK = new Float64Array( 1000 );
	info = dormbr('p', 'left', 'transpose', 3, 3, 3, A, 1, 4, 0, TAUP, 1, 0, C, 1, 3, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=Q, SIDE=L, TRANS=N (lower bidiagonal, NQ<K)', function t() {
	...
	C = eye( 3, 3 );
	WORK = new Float64Array( 1000 );
	info = dormbr('q', 'left', 'no-transpose', 3, 3, 4, A, 1, 3, 0, TAUQ, 1, 0, C, 1, 3, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=Q, SIDE=L, TRANS=T (lower bidiagonal, NQ<K)', function t() {
	...
	C = eye( 3, 3 );
	WORK = new Float64Array( 1000 );
	info = dormbr('q', 'left', 'transpose', 3, 3, 4, A, 1, 3, 0, TAUQ, 1, 0, C, 1, 3, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=P, SIDE=R, TRANS=N (lower bidiagonal, NQ>K)', function t() {
	...
	C = eye( 4, 4 );
	WORK = new Float64Array( 1000 );
	info = dormbr('p', 'right', 'no-transpose', 4, 4, 3, A, 1, 3, 0, TAUP, 1, 0, C, 1, 4, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=P, SIDE=R, TRANS=T (lower bidiagonal, NQ>K)', function t() {
	...
	C = eye( 4, 4 );
	WORK = new Float64Array( 1000 );
	info = dormbr('p', 'right', 'transpose', 4, 4, 3, A, 1, 3, 0, TAUP, 1, 0, C, 1, 4, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=P, SIDE=L, TRANS=N (lower bidiagonal, NQ>K)', function t() {
	...
	C = eye( 4, 4 );
	WORK = new Float64Array( 1000 );
	info = dormbr('p', 'left', 'no-transpose', 4, 4, 3, A, 1, 3, 0, TAUP, 1, 0, C, 1, 4, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=P, SIDE=L, TRANS=T (lower bidiagonal, NQ>K)', function t() {
	...
	C = eye( 4, 4 );
	WORK = new Float64Array( 1000 );
	info = dormbr('p', 'left', 'transpose', 4, 4, 3, A, 1, 3, 0, TAUP, 1, 0, C, 1, 4, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=Q, SIDE=R, TRANS=N (lower bidiagonal, NQ<K)', function t() {
	...
	C = eye( 3, 3 );
	WORK = new Float64Array( 1000 );
	info = dormbr('q', 'right', 'no-transpose', 3, 3, 4, A, 1, 3, 0, TAUQ, 1, 0, C, 1, 3, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=Q, SIDE=R, TRANS=T (lower bidiagonal, NQ<K)', function t() {
	...
	C = eye( 3, 3 );
	WORK = new Float64Array( 1000 );
	info = dormbr('q', 'right', 'transpose', 3, 3, 4, A, 1, 3, 0, TAUQ, 1, 0, C, 1, 3, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=Q, SIDE=L, TRANS=N, non-identity C (upper bidiagonal)', function t() { // eslint-disable-line max-len
	...
	WORK = new Float64Array( 1000 );
	info = dormbr('q', 'left', 'no-transpose', 4, 2, 3, A, 1, 4, 0, TAUQ, 1, 0, C, 1, 4, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: VECT=P, SIDE=R, TRANS=N, non-identity C (lower bidiagonal)', function t() { // eslint-disable-line max-len
	...
	WORK = new Float64Array( 1000 );
	info = dormbr('p', 'right', 'no-transpose', 3, 4, 3, A, 1, 3, 0, TAUP, 1, 0, C, 1, 3, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
...
test( 'dormbr: M=0 quick return', function t() {
	...
	info = dormbr('q', 'left', 'no-transpose', 0, 3, 0, A, 1, 1, 0, TAU, 1, 0, C, 1, 1, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0 );
});
...
test( 'dormbr: N=0 quick return', function t() {
	...
	C = new Float64Array( 1 );
	WORK = new Float64Array( 1 );
	info = dormbr('q', 'left', 'no-transpose', 3, 0, 0, A, 1, 1, 0, TAU, 1, 0, C, 1, 1, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0 );
});
...
test( 'dormbr: K=0, VECT=Q (dormqr with K=0, C unchanged)', function t() {
	...
	C = eye( 4, 4 );
	WORK = new Float64Array( 1000 );
	info = dormbr('q', 'left', 'no-transpose', 4, 4, 0, A, 1, 4, 0, TAU, 1, 0, C, 1, 4, 0, WORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0 );
	assertArrayClose( C, tc.C, 1e-14, 'C' );
});
