...
/**
* Solves a system of linear equations `A*X = B` with a real symmetric matrix `A` using the factorization computed by `dsytrf_rk`.
*
...
*/
function dsytrs3( order, uplo, N, nrhs, A, LDA, e, strideE, IPIV, strideIPIV, B, LDB ) {
	var sa1;
	var sa2;
	var sb1;
	var sb2;
