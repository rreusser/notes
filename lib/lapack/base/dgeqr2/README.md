...
dgeqr2.ndarray( N, N, A, N, 1, 0, TAU, 1, 0, WORK, 1, 0 );
```
...
-   `dgeqr2()` corresponds to the [LAPACK][lapack] level routine [`dgeqr2`][lapack-dgeqr2].
...
[lapack-dgeqr2]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dgeqr2.html
