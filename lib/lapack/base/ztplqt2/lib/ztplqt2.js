...
* @throws {RangeError} eighth argument must be greater than or equal to max(1,M) (column-major) or max(1,N) (row-major)
* @throws {RangeError} tenth argument must be greater than or equal to max(1,M) (column-major) or max(1,N) (row-major)
