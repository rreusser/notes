...
dorml2.ndarray( 'left', 'no-transpose', N, N, N, A, N, 1, 0, TAU, 1, 0, C, N, 1, 0, WORK, 1, 0 );
```
...
#### dorml2.ndarray( side, trans, M, N, K, A, strideA1, strideA2, offsetA, TAU, strideTAU, offsetTAU, C, strideC1, strideC2, offsetC, WORK, strideWORK, offsetWORK )
...
-   `dorml2()` corresponds to the [LAPACK][lapack] level routine [`dorml2`][lapack-dorml2].
...
[lapack-dorml2]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dorml2.html
