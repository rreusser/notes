...
dsytrs.ndarray( 'upper', N, N, A, N, 1, 0, IPIV, 1, 0, B, N, 1, 0 );
```
...
-   `dsytrs()` corresponds to the [LAPACK][lapack] level routine [`dsytrs`][lapack-dsytrs].
...
[lapack-dsytrs]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dsytrs.html
