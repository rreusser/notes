...
/**
* Overwrites the general `M`-by-`N` real matrix `C` with `Q*C`, `Q**T*C`, `C*Q`, or `C*Q**T`, where `Q` is a real orthogonal matrix defined as the product of `K` elementary reflectors returned by `dtzrzf`.
*
...
* @param {Float64Array} A - reflector vectors
...
*/
function dormr3( side, trans, M, N, K, l, A, strideA1, strideA2, offsetA, TAU, strideTAU, offsetTAU, C, strideC1, strideC2, offsetC, WORK, strideWORK, offsetWORK ) { // eslint-disable-line max-len, max-params
