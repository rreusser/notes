...
#### zlanht( norm, N, d, strideD, e, strideE )
...
-   `zlanht()` corresponds to the [LAPACK][lapack] level routine [`zlanht`][lapack-zlanht].
...
[lapack-zlanht]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zlanht.html
