...
dpotri.ndarray( 'upper', N, A, N, 1, 0 );
```
...
-   `dpotri()` corresponds to the [LAPACK][lapack] level routine [`dpotri`][lapack-dpotri].
...
[lapack-dpotri]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dpotri.html
