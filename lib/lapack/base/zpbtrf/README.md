...
zpbtrf.ndarray( 'upper', N, 1, AB, N, 1, 0 );
```
...
-   `zpbtrf()` corresponds to the [LAPACK][lapack] level routine [`zpbtrf`][lapack-zpbtrf].
...
[lapack-zpbtrf]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zpbtrf.html
