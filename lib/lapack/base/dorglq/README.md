...
dorglq.ndarray( N, N, N, A, N, 1, 0, TAU, 1, 0, WORK, 1, 0 );
```
...
-   `dorglq()` corresponds to the [LAPACK][lapack] level routine [`dorglq`][lapack-dorglq].
...
[lapack-dorglq]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dorglq.html
