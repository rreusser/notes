...
#### zstein( N, d, strideD, e, strideE, M, w, strideW, IBLOCK, strideIBLOCK, ISPLIT, strideISPLIT, Z, LDZ, WORK, strideWORK, IWORK, strideIWORK, IFAIL, strideIFAIL )
...
-   `zstein()` corresponds to the [LAPACK][lapack] level routine [`zstein`][lapack-zstein].
...
[lapack-zstein]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zstein.html
