...
var zstein = require( './../lib/ndarray.js' );
...
function createBenchmark( len ) {
	...
	var IBLOCK = uniform( N, -10.0, 10.0, options );
	var ISPLIT = uniform( N, -10.0, 10.0, options );
	...
	*/
	function benchmark( b ) {
		...
		for ( i = 0; i < b.iterations; i++ ) {
			y = zstein( N, d, 1, 0, e, 1, 0, N, w, 1, 0, IBLOCK, 1, 0, ISPLIT, 1, 0, Z, N, 1, 0, WORK, 1, 0, IWORK, 1, 0, IFAIL, 1, 0 );
			if ( isnan( y ) ) {
