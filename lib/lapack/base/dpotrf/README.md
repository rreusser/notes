...
dpotrf.ndarray( 'upper', N, A, N, 1, 0 );
```
...
-   `dpotrf()` corresponds to the [LAPACK][lapack] level routine [`dpotrf`][lapack-dpotrf].
...
[lapack-dpotrf]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dpotrf.html
