...
-   `iladlr()` corresponds to the [LAPACK][lapack] level routine [`iladlr`][lapack-iladlr].
...
[lapack-iladlr]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__iladlr.html
