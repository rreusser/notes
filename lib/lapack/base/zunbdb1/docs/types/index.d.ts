...
/**
* Interface describing `zunbdb1`.
*/
interface Routine {
	/**
	* Simultaneously bidiagonalizes the blocks of a tall and skinny complex matrix with orthonormal columns (CSD column-block-1 variant)
	*
	...
	*/
	...
	/**
	* Simultaneously bidiagonalizes the blocks of a tall and skinny complex matrix with orthonormal columns (CSD column-block-1 variant), using alternative indexing semantics.
	*
	* @param M - number of rows
	* @param p - p
	* @param q - q
