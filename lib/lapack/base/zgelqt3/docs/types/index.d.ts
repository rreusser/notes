...
/**
* Interface describing `zgelqt3`.
*/
interface Routine {
	/**
	* Recursively compute an LQ factorization of a complex M-by-N matrix using the compact WY representation of Q.
	*
	...
	*/
	...
	/**
	* Recursively compute an LQ factorization of a complex M-by-N matrix using the compact WY representation of Q., using alternative indexing semantics.
	*
	* @param M - number of rows
	* @param N - number of columns
	* @param A - input matrix
