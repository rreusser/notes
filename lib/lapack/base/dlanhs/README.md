...
-   `dlanhs()` corresponds to the [LAPACK][lapack] level routine [`dlanhs`][lapack-dlanhs].
...
[lapack-dlanhs]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dlanhs.html
