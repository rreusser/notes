...
* @param {Float64Array} WORK - workspace buffer (>= N*nb if `side='left'` or M*nb if `side='right'`)
...
*/
function dtpmqrt( order, side, trans, M, N, K, l, nb, V, LDV, T, LDT, A, LDA, B, LDB, WORK, strideWORK ) {
	var ldvq;
	var ldaq;
	var sv1;
	var sv2;
