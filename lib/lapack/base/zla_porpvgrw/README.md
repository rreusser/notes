...
#### zla_porpvgrw( uplo, ncols, A, LDA, AF, LDAF, WORK )
...
#### zla_porpvgrw.ndarray( uplo, ncols, A, strideA1, strideA2, offsetA, AF, strideAF1, strideAF2, offsetAF, WORK, strideWORK, offsetWORK )
...
-   `zla_porpvgrw()` corresponds to the [LAPACK][lapack] level routine [`zla_porpvgrw`][lapack-zla_porpvgrw].
...
[lapack-zla_porpvgrw]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zla_porpvgrw.html
