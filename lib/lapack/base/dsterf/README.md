...
-   `dsterf()` corresponds to the [LAPACK][lapack] level routine [`dsterf`][lapack-dsterf].
...
[lapack-dsterf]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dsterf.html
