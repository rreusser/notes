...
var out = zgesvx( 'not-factored', 'no-transpose', N, N, A, N, AF, N, IPIV, 1, 'none', r, 1, c, 1, B, N, X, N, FERR, 1, BERR, 1, WORK, 1, RWORK, 1 );
console.log( out );

// Using the ndarray interface:
out = zgesvx.ndarray( 'not-factored', 'no-transpose', N, N, A, N, 1, 0, AF, N, 1, 0, IPIV, 1, 0, 'none', r, 1, 0, c, 1, 0, B, N, 1, 0, X, N, 1, 0, 1.0, FERR, 1, 0, BERR, 1, 0, WORK, 1, 0, RWORK, 1, 0 );
console.log( out );
