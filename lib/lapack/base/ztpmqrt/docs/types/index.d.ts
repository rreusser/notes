...
interface Routine {
	/**
	* Apply complex unitary matrix Q (or Q**H) from a triangular-pentagonal compact-WY block reflector to a stacked matrix C.
	*
	...
	*/
	...
	/**
	* Apply complex unitary matrix Q (or Q**H) from a triangular-pentagonal compact-WY block reflector to a stacked matrix C., using alternative indexing semantics.
	*
	* @param side - specifies the operation type
	* @param trans - specifies the operation type
	* @param M - number of rows
