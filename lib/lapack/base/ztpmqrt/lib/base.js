...
* @param {Complex128Array} WORK - workspace buffer (logically `nb`-by-`N` for `side='left'` or `M`-by-`nb` for `side='right'`, in complex elements; caller-allocated, must hold at least `nb*N` (left) or `M*nb` (right) complex elements)
