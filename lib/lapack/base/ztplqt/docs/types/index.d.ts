...
/**
* Interface describing `ztplqt`.
*/
interface Routine {
	/**
	* Computes a blocked LQ factorization of a complex triangular-pentagonal matrix using the compact WY representation for Q.
	*
	...
	*/
	...
	/**
	* Computes a blocked LQ factorization of a complex triangular-pentagonal matrix using the compact WY representation for Q., using alternative indexing semantics.
	*
	* @param M - number of rows
	* @param N - number of columns
	* @param l - l
