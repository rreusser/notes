...
- String parameters (`direct`, `pivot`, `side`) use single-char Fortran convention in base.js; ndarray.js normalizes from stdlib full-word strings.
...
- All parameter combinations for `direct`, `pivot`, `side` should be tested to ensure full branch coverage.
