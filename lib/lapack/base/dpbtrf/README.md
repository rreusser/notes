...
dpbtrf.ndarray( 'upper', N, 1, AB, N, 1, 0 );
```
...
-   `dpbtrf()` corresponds to the [LAPACK][lapack] level routine [`dpbtrf`][lapack-dpbtrf].
...
[lapack-dpbtrf]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dpbtrf.html
