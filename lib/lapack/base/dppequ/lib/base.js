...
* @param {Float64Array} AP - input symmetric positive definite matrix in packed storage, length `N*(N+1)/2`
...
*/
function dppequ( uplo, N, AP, strideAP, offsetAP, s, strideS, offsetS ) {
	var smin;
	var amax;
	var jj;
	var si;
