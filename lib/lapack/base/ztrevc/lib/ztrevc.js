...
*/
function ztrevc( order, side, howmny, SELECT, strideSELECT, N, T, LDT, VL, LDVL, VR, LDVR, mm, M, WORK, strideWORK, RWORK, strideRWORK ) { // eslint-disable-line max-len, max-params
	var svl1;
	var svl2;
	var svr1;
	var svr2;
	...
	if ( !isOperationSide( side ) && side !== 'both' ) {
	...
	return base( side, howmny, SELECT, strideSELECT, 0, N, T, st1, st2, 0, VL, svl1, svl2, 0, VR, svr1, svr2, 0, mm, M, WORK, strideWORK, 0, RWORK, strideRWORK, 0 ); // eslint-disable-line max-len
}
