...
* @throws {RangeError} third argument must be greater than or equal to the second argument
...
*/
function dgelqt3( order, M, N, A, LDA, T, LDT ) {
	var sa1;
	var sa2;
	var st1;
	var st2;
	...
	if ( order === 'row-major' && LDT < max( 1, M ) ) {
