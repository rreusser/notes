...
dpocon.ndarray( 'upper', N, A, N, 1, 0, 1.0, 1.0, WORK, 1, 0, IWORK, 1, 0 );
```
...
-   `dpocon()` corresponds to the [LAPACK][lapack] level routine [`dpocon`][lapack-dpocon].
...
[lapack-dpocon]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dpocon.html
