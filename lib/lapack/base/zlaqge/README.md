...
-   `zlaqge()` corresponds to the [LAPACK][lapack] level routine [`zlaqge`][lapack-zlaqge].
...
[lapack-zlaqge]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zlaqge.html
