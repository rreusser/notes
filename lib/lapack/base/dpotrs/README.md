...
dpotrs.ndarray( 'upper', N, N, A, N, 1, 0, B, N, 1, 0 );
```
...
-   `dpotrs()` corresponds to the [LAPACK][lapack] level routine [`dpotrs`][lapack-dpotrs].
...
[lapack-dpotrs]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dpotrs.html
