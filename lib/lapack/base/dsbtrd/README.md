...
-   `dsbtrd()` corresponds to the [LAPACK][lapack] level routine [`dsbtrd`][lapack-dsbtrd].
...
[lapack-dsbtrd]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dsbtrd.html
