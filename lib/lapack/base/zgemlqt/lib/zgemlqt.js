...
*/
function zgemlqt( order, side, trans, M, N, K, mb, V, LDV, T, LDT, C, LDC, WORK, strideWORK ) {
	var sv1;
	var sv2;
	var st1;
	var st2;
	...
	return base( side, trans, M, N, K, mb, V, sv1, sv2, 0, T, st1, st2, 0, C, sc1, sc2, 0, WORK, strideWORK, 0 );
}
