...
-   `dpoequ()` corresponds to the [LAPACK][lapack] level routine [`dpoequ`][lapack-dpoequ].
...
[lapack-dpoequ]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dpoequ.html
