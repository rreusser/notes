...
dorg2r.ndarray( N, N, N, A, N, 1, 0, TAU, 1, 0, WORK, 1, 0 );
```
...
-   `dorg2r()` corresponds to the [LAPACK][lapack] level routine [`dorg2r`][lapack-dorg2r].
...
[lapack-dorg2r]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dorg2r.html
