...
#### dgtts2( itrans, N, nrhs, DL, strideDL, d, strideD, DU, strideDU, DU2, strideDU2, IPIV, strideIPIV, B, LDB )
...
-   `dgtts2()` corresponds to the [LAPACK][lapack] level routine [`dgtts2`][lapack-dgtts2].
...
[lapack-dgtts2]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dgtts2.html
