...
/**
* Computes the inverse of a complex symmetric matrix using the factorization computed by `zsytrf_rook`.
*
...
*/
function zsytriRook( order, uplo, N, A, LDA, IPIV, strideIPIV, WORK ) {
	var sa1;
	var sa2;
	var oi;
