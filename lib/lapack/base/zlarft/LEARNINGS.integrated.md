...
- String parameters (`direct`, `storev`) use single-char Fortran convention in base.js; ndarray.js normalizes from stdlib full-word strings.
...
- Dependencies: `reinterpret-complex128`, `zgemm`, `zgemv`, `ztrmv`. No unexpected interface issues encountered.
...
- All parameter combinations for `direct`, `storev` should be tested to ensure full branch coverage.
