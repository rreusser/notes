...
dtrtri.ndarray( 'upper', 'non-unit', N, A, N, 1, 0 );
```
...
-   `dtrtri()` corresponds to the [LAPACK][lapack] level routine [`dtrtri`][lapack-dtrtri].
...
[lapack-dtrtri]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dtrtri.html
