...
dtrti2.ndarray( 'upper', 'non-unit', N, A, N, 1, 0 );
```
...
-   `dtrti2()` corresponds to the [LAPACK][lapack] level routine [`dtrti2`][lapack-dtrti2].
...
[lapack-dtrti2]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dtrti2.html
