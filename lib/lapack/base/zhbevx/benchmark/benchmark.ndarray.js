...
var zhbevx = require( './../lib/ndarray.js' );
	...
	*/
	function benchmark( b ) {
		...
		for ( i = 0; i < b.iterations; i++ ) {
			y = zhbevx( 'compute-vectors', 'all', 'upper', N, 1, AB, N, 1, 0, Q, N, 1, 0, 1.0, 1.0, 1, N, 1.0, 1, w, 1, 0, Z, N, 1, 0, WORK, 1, 0, RWORK, 1, 0, IWORK, 1, 0, IFAIL, 1, 0 );
			if ( isnan( y ) ) {
