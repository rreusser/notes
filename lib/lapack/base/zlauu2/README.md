...
zlauu2.ndarray( 'upper', N, A, N, 1, 0 );
```
...
-   `zlauu2()` corresponds to the [LAPACK][lapack] level routine [`zlauu2`][lapack-zlauu2].
...
[lapack-zlauu2]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zlauu2.html
