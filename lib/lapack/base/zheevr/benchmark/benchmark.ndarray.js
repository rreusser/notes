...
var zheevr = require( './../lib/ndarray.js' );
...
function createBenchmark( len ) {
	...
	var ISUPPZ = uniform( N, -10.0, 10.0, options );
	...
	*/
	function benchmark( b ) {
		...
		for ( i = 0; i < b.iterations; i++ ) {
			y = zheevr( 'compute-vectors', 'all', 'upper', N, A, N, 1, 0, 1.0, 1.0, 1, N, 1.0, 1, w, 1, 0, Z, N, 1, 0, ISUPPZ, 1, 0, WORK, 1, 0, -1, RWORK, 1, 0, 1, IWORK, 1, 0, 1 );
			if ( isnan( y ) ) {
