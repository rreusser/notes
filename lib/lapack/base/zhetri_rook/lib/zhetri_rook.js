...
/**
* Computes the inverse of a complex Hermitian matrix using the factorization computed by `zhetrf_rook`.
*
...
* @param {Complex128Array} WORK - workspace of length at least `N`
...
*/
function zhetriRook( order, uplo, N, A, LDA, IPIV, strideIPIV, WORK ) {
	var sa1;
	var sa2;
	var oi;
