...
-   `zlansb()` corresponds to the [LAPACK][lapack] level routine [`zlansb`][lapack-zlansb].
...
[lapack-zlansb]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zlansb.html
