...
dorg2l.ndarray( N, N, N, A, N, 1, 0, TAU, 1, 0, WORK, 1, 0 );
```
...
-   `dorg2l()` corresponds to the [LAPACK][lapack] level routine [`dorg2l`][lapack-dorg2l].
...
[lapack-dorg2l]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dorg2l.html
