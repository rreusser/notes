...
* @throws {RangeError} sixth argument (`N`) must be a nonnegative integer
* @throws {RangeError} leading dimensions must satisfy LDA, LDB, LDVL, LDVR >= max(1, N)
* @returns {integer} status code (0 = success)
*/
function dtgsna( order, job, howmny, SELECT, strideSELECT, N, A, LDA, B, LDB, VL, LDVL, VR, LDVR, s, strideS, DIF, strideDIF, mm, M, WORK, strideWORK, lwork, IWORK, strideIWORK, offsetIWORK ) { // eslint-disable-line max-len, max-params
	var svl1;
	var svl2;
	var svr1;
	var svr2;
