...
/**
* Computes a QR factorization of a real M-by-N matrix using the compact WY representation of Q.
*
...
*/
function dgeqrt2( order, M, N, A, LDA, T, LDT ) { // eslint-disable-line max-len, max-params
	var sa1;
	var sa2;
	var st1;
	var st2;
	...
	return base( M, N, A, sa1, sa2, 0, T, st1, st2, 0 ); // eslint-disable-line max-len
}
