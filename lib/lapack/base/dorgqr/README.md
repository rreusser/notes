...
dorgqr.ndarray( N, N, N, A, N, 1, 0, TAU, 1, 0, WORK, 1, 0 );
```
...
-   `dorgqr()` corresponds to the [LAPACK][lapack] level routine [`dorgqr`][lapack-dorgqr].
...
[lapack-dorgqr]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dorgqr.html
