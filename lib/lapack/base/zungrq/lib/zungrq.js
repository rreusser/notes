...
* @throws {RangeError} sixth argument must be greater than or equal to max(1,M) for column-major or max(1,N) for row-major
* @returns {integer} status code (0 = success)
*/
function zungrq( order, M, N, K, A, LDA, TAU, strideTAU, WORK, strideWORK ) {
	var sa1;
	var sa2;
	var ot;
	var ow;
