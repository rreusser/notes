...
zungqr.ndarray( N, N, N, A, N, 1, 0, TAU, 1, 0, WORK, 1, 0 );
```
...
-   `zungqr()` corresponds to the [LAPACK][lapack] level routine [`zungqr`][lapack-zungqr].
...
[lapack-zungqr]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zungqr.html
