...
zpotrf.ndarray( 'upper', N, A, N, 1, 0 );
```
...
-   `zpotrf()` corresponds to the [LAPACK][lapack] level routine [`zpotrf`][lapack-zpotrf].
...
[lapack-zpotrf]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zpotrf.html
