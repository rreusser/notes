...
/**
* Interface describing `dorbdb4`.
*/
interface Routine {
	/**
	* Simultaneously bidiagonalize the blocks of a tall and skinny matrix [X11; X21] with orthonormal columns (CSD-prep variant 4 — widest M1/M2).
	*
	...
	* @param PHANTOM - input array
	* @param stridePHANTOM - stride length for `PHANTOM`
	* @param WORK - output array
	* @param strideWORK - stride length for `WORK`
	* @returns result
	*/
	( order: Layout, M: number, p: number, q: number, X11: Float64Array, LDX11: number, X21: Float64Array, LDX21: number, THETA: Float64Array, strideTHETA: number, PHI: Float64Array, stridePHI: number, TAUP1: Float64Array, strideTAUP1: number, TAUP2: Float64Array, strideTAUP2: number, TAUQ1: Float64Array, strideTAUQ1: number, PHANTOM: Float64Array, stridePHANTOM: number, WORK: Float64Array, strideWORK: number ): Float64Array;

	/**
	* Simultaneously bidiagonalize the blocks of a tall and skinny matrix [X11; X21] with orthonormal columns (CSD-prep variant 4 — widest M1/M2)., using alternative indexing semantics.
	*
	* @param M - number of rows
	* @param p - p
	* @param q - q
