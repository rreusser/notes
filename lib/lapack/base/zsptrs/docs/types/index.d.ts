...
interface Routine {
	...
	* @returns result
	*/
	( order: Layout, uplo: MatrixTriangle, N: number, nrhs: number, AP: Float64Array, IPIV: Int32Array, B: Float64Array, LDB: number ): Float64Array;
