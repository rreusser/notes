...
dlaset.ndarray( 'upper', N, N, 1.0, 1.0, A, N, 1, 0 );
```
...
-   `dlaset()` corresponds to the [LAPACK][lapack] level routine [`dlaset`][lapack-dlaset].
...
[lapack-dlaset]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dlaset.html
