...
/**
* Generates an M-by-N real matrix Q with orthonormal rows from elementary reflectors returned by DGERQF.
*
...
*/
function dorgrq( order, M, N, K, A, LDA, TAU, strideTAU, WORK, strideWORK ) {
	var sa1;
	var sa2;
	var ot;
	var ow;
