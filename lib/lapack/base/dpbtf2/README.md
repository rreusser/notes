...
dpbtf2.ndarray( 'upper', N, 1, AB, N, 1, 0 );
```
...
-   `dpbtf2()` corresponds to the [LAPACK][lapack] level routine [`dpbtf2`][lapack-dpbtf2].
...
[lapack-dpbtf2]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dpbtf2.html
