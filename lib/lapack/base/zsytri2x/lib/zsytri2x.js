...
/**
* Computes the inverse of a complex symmetric indefinite matrix using the factorization produced by `zsytrf` (classic Bunch-Kaufman, worker routine called by `zsytri2`).
*
...
*/
function zsytri2x( order, uplo, N, A, LDA, IPIV, strideIPIV, offsetIPIV, WORK, strideWORK, nb ) {
	var sa1;
	var sa2;
