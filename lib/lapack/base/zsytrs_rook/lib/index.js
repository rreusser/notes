...
/**
* Solve a complex symmetric indefinite system using the factorization from `zsytrf_rook` (rook pivoting Bunch-Kaufman).
*
* @module @stdlib/lapack/base/zsytrs-rook
*
* @example
...
// exports: { "ndarray": "zsytrsRook.ndarray" }
