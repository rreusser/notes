...
/**
* Overwrites the M-by-N matrix C with Q_C, Q^H_C, C_Q, or C_Q^H, where Q is a complex unitary matrix defined as the product of K elementary reflectors from an RQ factorization (`Q = H(1)^H H(2)^H ... H(k)^H`) as returned by ZGERQF.
*
...
*/
function zunmrq( order, side, trans, M, N, K, A, LDA, TAU, strideTAU, C, LDC, WORK, strideWORK ) {
	var sa1;
	var sa2;
	var sc1;
	var sc2;
