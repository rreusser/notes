...
* @param {Float64Array} WORK - workspace buffer (logically `ldwork`-by-`mb` with leading dimension `ldwork = max(1,N)` for `side='left'` or `max(1,M)` for `side='right'`)
