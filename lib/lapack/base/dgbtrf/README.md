...
-   `dgbtrf()` corresponds to the [LAPACK][lapack] level routine [`dgbtrf`][lapack-dgbtrf].
...
[lapack-dgbtrf]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dgbtrf.html
