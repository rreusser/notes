	...
	*/
	function benchmark( b ) {
		...
		for ( i = 0; i < b.iterations; i++ ) {
			info = dla_gbrfsx_extended( 'column-major', 2, 'no-transpose', N, 1, 1, 1, p.AB, 3, p.AFB, 4, p.IPIV, 1, 0, false, p.colScale, 1, p.rhs, N, p.soln, N, p.BERR_OUT, 1, 2, p.EBN, 1, p.EBC, 1, p.RES, 1, p.AYB, 1, p.DY, 1, p.YT, 1, 1e-2, 10, 0.5, 0.25, false );
			if ( info !== 0 ) {
