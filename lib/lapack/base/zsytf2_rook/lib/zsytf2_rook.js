...
*/
function zsytf2Rook( order, uplo, N, A, LDA, IPIV, strideIPIV, offsetIPIV ) { // eslint-disable-line max-len, max-params
	var sa1;
	var sa2;
	...
	return base( uplo, N, A, sa1, sa2, 0, IPIV, strideIPIV, offsetIPIV ); // eslint-disable-line max-len
}
