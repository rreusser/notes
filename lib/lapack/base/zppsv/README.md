...
zppsv.ndarray( 'upper', 3, 1, AP, 1, 0, B, 1, 3, 0 );
```
...
-   `zppsv()` corresponds to the [LAPACK][lapack] level routine [`zppsv`][lapack-zppsv].
...
[lapack-zppsv]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zppsv.html
