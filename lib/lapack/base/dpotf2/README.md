...
dpotf2.ndarray( 'upper', N, A, N, 1, 0 );
```
...
-   `dpotf2()` corresponds to the [LAPACK][lapack] level routine [`dpotf2`][lapack-dpotf2].
...
[lapack-dpotf2]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dpotf2.html
