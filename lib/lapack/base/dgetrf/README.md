...
dgetrf( 'column-major', 3, 3, A, 3, IPIV, 1 );
```
...
-   `dgetrf()` corresponds to the [LAPACK][lapack] level routine [`dgetrf`][lapack-dgetrf].
...
[lapack-dgetrf]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dgetrf.html
