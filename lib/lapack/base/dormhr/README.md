...
-   `dormhr()` corresponds to the [LAPACK][lapack] level routine [`dormhr`][lapack-dormhr].
...
[lapack-dormhr]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dormhr.html
