...
var out = zhgeqz( 'row-major', 'both', 'update', 'update', N, N, N, H, N, T, N, ALPHA, 1, BETA, 1, Q, N, Z, N, WORK, 1, N, RWORK, 1 );
console.log( out );

// Using the ndarray interface:
out = zhgeqz.ndarray( 'both', 'update', 'update', N, N, N, H, N, 1, 0, T, N, 1, 0, ALPHA, 1, 0, BETA, 1, 0, Q, N, 1, 0, Z, N, 1, 0, WORK, 1, 0, N, RWORK, 1, 0 );
console.log( out );
