...
-   `dsyrfs()` corresponds to the [LAPACK][lapack] level routine [`dsyrfs`][lapack-dsyrfs].
...
[lapack-dsyrfs]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dsyrfs.html
