...
/**
* Computes the inverse of a real symmetric matrix using the factorization computed by `dsytrf_rook`.
*
...
*/
function dsytriRook( order, uplo, N, A, LDA, IPIV, strideIPIV, WORK ) {
	var sa1;
	var sa2;
	var oi;
