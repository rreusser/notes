...
/**
* Compute the inverse of a real symmetric indefinite matrix using the factorization from `dsytrf_rook` (rook pivoting Bunch-Kaufman).
*
* @module @stdlib/lapack/base/dsytri-rook
*
* @example
...
// exports: { "ndarray": "dsytriRook.ndarray" }
