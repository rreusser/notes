...
var out = dlabrd( 'row-major', N, N, N, A, N, d, 1, e, 1, TAUQ, 1, TAUP, 1, X, N, Y, N );
console.log( out );

// Using the ndarray interface:
out = dlabrd.ndarray( N, N, N, A, N, 1, 0, d, 1, 0, e, 1, 0, TAUQ, 1, 0, TAUP, 1, 0, X, N, 1, 0, Y, N, 1, 0 );
console.log( out );
