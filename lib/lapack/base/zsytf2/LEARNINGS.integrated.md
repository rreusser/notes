...
- String parameters (`pivot`, `uplo`) use single-char Fortran convention in base.js; ndarray.js normalizes from stdlib full-word strings.
...
- Dependencies: `izamax`, `reinterpret-complex128`, `zscal`, `zswap`. No unexpected interface issues encountered.
...
- All parameter combinations for `pivot`, `uplo` should be tested to ensure full branch coverage.
