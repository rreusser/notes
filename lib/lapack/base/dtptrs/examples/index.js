...
var dtptrs = require( './../lib' ); // eslint-disable-line stdlib/require-file-extensions
...
var info = dtptrs( 'column-major', 'upper', 'no-transpose', 'non-unit', 3, 1, AP, B, 3 );
console.log( 'info:', info ); // eslint-disable-line no-console
console.log( 'solution:', B ); // eslint-disable-line no-console
