...
zlanhe.ndarray( '1', 'upper', N, A, N, 1, 0, WORK, 1, 0 );
```
...
-   `zlanhe()` corresponds to the [LAPACK][lapack] level routine [`zlanhe`][lapack-zlanhe].
...
[lapack-zlanhe]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zlanhe.html
