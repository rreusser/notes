...
-   `zgetrf()` corresponds to the [LAPACK][lapack] level routine [`zgetrf`][lapack-zgetrf].
...
[lapack-zgetrf]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zgetrf.html
