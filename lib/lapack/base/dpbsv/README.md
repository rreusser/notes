...
dpbsv.ndarray( 'upper', N, 1, N, AB, N, 1, 0, B, N, 1, 0 );
```
...
-   `dpbsv()` corresponds to the [LAPACK][lapack] level routine [`dpbsv`][lapack-dpbsv].
...
[lapack-dpbsv]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dpbsv.html
