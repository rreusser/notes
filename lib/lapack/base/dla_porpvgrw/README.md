...
#### dla_porpvgrw.ndarray( uplo, ncols, A, strideA1, strideA2, offsetA, AF, strideAF1, strideAF2, offsetAF, WORK, strideWORK, offsetWORK )
...
-   `dla_porpvgrw()` corresponds to the [LAPACK][lapack] level routine [`dla_porpvgrw`][lapack-dla_porpvgrw].
...
[lapack-dla_porpvgrw]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dla_porpvgrw.html
