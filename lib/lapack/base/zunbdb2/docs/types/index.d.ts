...
/**
* Interface describing `zunbdb2`.
*/
interface Routine {
	/**
	* Simultaneously bidiagonalizes the blocks of a tall and skinny complex matrix [X11; X21] with orthonormal columns (P <= min(M-P, Q, M-Q))
	*
	...
	*/
	...
	/**
	* Simultaneously bidiagonalizes the blocks of a tall and skinny complex matrix [X11; X21] with orthonormal columns (P <= min(M-P, Q, M-Q)), using alternative indexing semantics.
	*
	* @param M - number of rows
	* @param p - p
	* @param q - q
