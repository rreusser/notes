...
*/
function zhetri2( order, uplo, N, A, LDA, IPIV, strideIPIV, offsetIPIV, WORK, strideWORK ) {
	var sa1;
	var sa2;
	...
	return base( uplo, N, A, sa1, sa2, 0, IPIV, strideIPIV, offsetIPIV, WORK, strideWORK, 0 );
}
