...
/**
* Interface describing `zhetri2`.
*/
interface Routine {
	/**
	* Computes the inverse of a complex Hermitian indefinite matrix using a Bunch-Kaufman factorization
	*
	...
	*/
	...
	/**
	* Computes the inverse of a complex Hermitian indefinite matrix using a Bunch-Kaufman factorization, using alternative indexing semantics.
	*
	* @param uplo - specifies the operation type
	* @param N - number of columns
	* @param A - input matrix
