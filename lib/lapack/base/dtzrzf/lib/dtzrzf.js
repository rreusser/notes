...
/**
* Reduces a real M-by-N (M <= N) upper trapezoidal matrix `A` to upper triangular form via RZ factorization (blocked driver).
*
...
*/
function dtzrzf( order, M, N, A, LDA, TAU, strideTAU, WORK, strideWORK ) {
	var sa1;
	var sa2;
	var ot;
	var ow;
