...
#### dlasr( order, side, pivot, direct, M, N, c, strideC, s, strideS, A, LDA )
...
-   `dlasr()` corresponds to the [LAPACK][lapack] level routine [`dlasr`][lapack-dlasr].
...
[lapack-dlasr]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dlasr.html
