...
* @param {Float64Array} WORK - workspace buffer (>= N*mb if `side='left'` or M*mb if `side='right'`)
...
function dtpmlqt( order, side, trans, M, N, K, l, mb, V, LDV, T, LDT, A, LDA, B, LDB, WORK, strideWORK ) {
	...
	return base( side, trans, M, N, K, l, mb, V, sv1, sv2, 0, T, st1, st2, 0, A, sa1, sa2, 0, B, sb1, sb2, 0, WORK, strideWORK, 0 );
}
