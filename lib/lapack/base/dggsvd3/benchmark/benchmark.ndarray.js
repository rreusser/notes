...
var dggsvd3 = require( './../lib/ndarray.js' );
	...
	*/
	function benchmark( b ) {
		...
		for ( i = 0; i < b.iterations; i++ ) {
			y = dggsvd3( 'compute-U', 'compute-V', 'compute-Q', N, N, 1, N, 1, A, N, 1, 0, B, N, 1, 0, ALPHA, 1, 0, BETA, 1, 0, U, N, 1, 0, V, N, 1, 0, Q, N, 1, 0, WORK, 1, 0, -1, IWORK, 1, 0 );
			if ( isnan( y ) ) {
