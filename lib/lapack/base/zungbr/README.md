...
zungbr.ndarray( 'q', N, N, N, A, N, 1, 0, TAU, 1, 0, WORK, 1, 0 );
```
...
-   `zungbr()` corresponds to the [LAPACK][lapack] level routine [`zungbr`][lapack-zungbr].
...
[lapack-zungbr]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zungbr.html
