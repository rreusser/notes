...
-   `dlasyf()` corresponds to the [LAPACK][lapack] level routine [`dlasyf`][lapack-dlasyf].
...
[lapack-dlasyf]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dlasyf.html
