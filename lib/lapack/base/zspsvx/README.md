...
#### zspsvx( fact, uplo, N, nrhs, AP, AFP, IPIV, strideIPIV, B, LDB, X, LDX, rcond, FERR, strideFERR, BERR, strideBERR, WORK, strideWORK, RWORK, strideRWORK )
...
-   `zspsvx()` corresponds to the [LAPACK][lapack] level routine [`zspsvx`][lapack-zspsvx].
...
[lapack-zspsvx]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zspsvx.html
