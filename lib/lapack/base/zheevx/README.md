...
-   `zheevx()` corresponds to the [LAPACK][lapack] level routine [`zheevx`][lapack-zheevx].
...
[lapack-zheevx]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zheevx.html
