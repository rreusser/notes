...
#### zspsv( uplo, N, nrhs, AP, IPIV, strideIPIV, B, LDB )
...
-   `zspsv()` corresponds to the [LAPACK][lapack] level routine [`zspsv`][lapack-zspsv].
...
[lapack-zspsv]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zspsv.html
