...
interface Routine {
	...
	* @returns result
	*/
	( uplo: MatrixTriangle, N: number, nrhs: number, AP: Float64Array, IPIV: Int32Array, strideIPIV: number, B: Float64Array, LDB: number ): Float64Array;
