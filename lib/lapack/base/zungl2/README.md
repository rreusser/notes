...
zungl2.ndarray( N, N, N, A, N, 1, 0, TAU, 1, 0, WORK, 1, 0 );
```
...
-   `zungl2()` corresponds to the [LAPACK][lapack] level routine [`zungl2`][lapack-zungl2].
...
[lapack-zungl2]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zungl2.html
