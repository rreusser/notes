...
/**
* Computes the inverse of a complex symmetric indefinite matrix using the factorization produced by `zsytrf` (dispatches between `zsytri` and `zsytri2x` based on `N`), using alternative indexing semantics.
*
...
* @param {Complex128Array} WORK - workspace; size depends on dispatch (see `lib/base.js`)
