...
Computes the Cholesky factorization with complete pivoting of a complex Hermitian positive semi-definite matrix (blocked algorithm), using alternative indexing semantics.
...
-   `zpstrf()` corresponds to the [LAPACK][lapack] level routine [`zpstrf`][lapack-zpstrf].
...
[lapack-zpstrf]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zpstrf.html
