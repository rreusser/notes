...
zlaqhb( 'upper', 4, 1, AB, 2, S, 1, 0.02, 25.0 );
```
...
-   `zlaqhb()` corresponds to the [LAPACK][lapack] level routine [`zlaqhb`][lapack-zlaqhb].
...
[lapack-zlaqhb]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zlaqhb.html
