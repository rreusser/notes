...
interface Routine {
	...
	* @returns result
	*/
	( order: Layout, uplo: string, N: number, A: Float64Array, LDA: number, AF: Float64Array, LDAF: number, x: Float64Array, strideX: number, WORK: Float64Array, strideWORK: number, RWORK: Float64Array, strideRWORK: number ): Float64Array;
