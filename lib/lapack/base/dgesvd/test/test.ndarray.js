...
var dgesvd = require( './../lib/ndarray.js' );
...
test( 'dgesvd: 1x1 edge case', function t() {
	...
	var U = new Float64Array( 1 );
	var VT = new Float64Array( 1 );
	var info = dgesvd( 'all', 'all', 1, 1, A, 1, 1, 0, s, 1, 0, U, 1, 1, 0, VT, 1, 1, 0 );
	assert.equal( info, tc.info );
...
test( 'dgesvd: 4x3 full SVD (JOBU=A, JOBVT=A) — Path 9', function t() {
	...
	var info = dgesvd( 'all', 'all', M, N, A, 1, M, 0, s, 1, 0, U, 1, M, 0, VT, 1, N, 0 );
	assert.equal( info, 0 );
...
test( 'dgesvd: 4x3 compact SVD (JOBU=S, JOBVT=S) — Path 6', function t() {
	...
	var info = dgesvd( 'some', 'some', M, N, A, 1, M, 0, s, 1, 0, U, 1, M, 0, VT, 1, minmn, 0 );
	assert.equal( info, 0 );
...
test( 'dgesvd: 4x3 JOBU=O, JOBVT=S — Path 3', function t() {
	...
	var info = dgesvd( 'overwrite', 'some', M, N, A, 1, M, 0, s, 1, 0, U, 1, 1, 0, VT, 1, minmn, 0 );
	assert.equal( info, 0 );
...
test( 'dgesvd: 4x3 JOBU=S, JOBVT=O — Path 5', function t() {
	...
	var info = dgesvd( 'some', 'overwrite', M, N, A, 1, M, 0, s, 1, 0, U, 1, M, 0, VT, 1, 1, 0 );
	assert.equal( info, 0 );
...
test( 'dgesvd: 4x3 JOBU=A, JOBVT=S — Path 9', function t() {
	...
	var info = dgesvd( 'all', 'some', M, N, A, 1, M, 0, s, 1, 0, U, 1, M, 0, VT, 1, minmn, 0 );
	assert.equal( info, 0 );
...
test( 'dgesvd: 3x4 JOBU=N, JOBVT=S — Path 4t', function t() {
	...
	var info = dgesvd( 'none', 'some', M, N, A, 1, M, 0, s, 1, 0, U, 1, 1, 0, VT, 1, minmn, 0 );
	assert.equal( info, 0 );
...
test( 'dgesvd: 3x4 JOBU=S, JOBVT=N — Path 1t (with U)', function t() {
	...
	var info = dgesvd( 'some', 'none', M, N, A, 1, M, 0, s, 1, 0, U, 1, M, 0, VT, 1, 1, 0 );
	assert.equal( info, 0 );
...
test( 'dgesvd: 4x3 JOBU=N, JOBVT=A — Path 1 (with VT)', function t() {
	...
	var info = dgesvd( 'none', 'all', M, N, A, 1, M, 0, s, 1, 0, U, 1, 1, 0, VT, 1, N, 0 );
	assert.equal( info, 0 );
...
test( 'dgesvd: 3x4 JOBU=A, JOBVT=N — Path 1t (with full U)', function t() {
	...
	var info = dgesvd( 'all', 'none', M, N, A, 1, M, 0, s, 1, 0, U, 1, M, 0, VT, 1, 1, 0 );
	assert.equal( info, 0 );
...
test( 'dgesvd: 4x3 JOBU=A, JOBVT=O — Path 8', function t() {
	...
	var info = dgesvd( 'all', 'overwrite', M, N, A, 1, M, 0, s, 1, 0, U, 1, M, 0, VT, 1, 1, 0 );
	assert.equal( info, 0 );
...
test( 'dgesvd: 3x4 JOBU=S, JOBVT=A — Path 9t', function t() {
	...
	var info = dgesvd( 'some', 'all', M, N, A, 1, M, 0, s, 1, 0, U, 1, M, 0, VT, 1, N, 0 );
	assert.equal( info, 0 );
...
test( 'dgesvd: 3x4 JOBU=O, JOBVT=A — Path 8t', function t() {
	...
	var info = dgesvd( 'overwrite', 'all', M, N, A, 1, M, 0, s, 1, 0, U, 1, 1, 0, VT, 1, N, 0 );
	assert.equal( info, 0 );
