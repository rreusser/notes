...
* @throws {RangeError} fifth argument must be valid for the given order
* @returns {integer} status code (0 = success)
*/
function zgeqr2p( order, M, N, A, LDA, TAU, strideTAU, WORK, strideWORK ) { // eslint-disable-line max-len, max-params
	var sa1;
	var sa2;
	...
	return base( M, N, A, sa1, sa2, 0, TAU, strideTAU, 0, WORK, strideWORK, 0 ); // eslint-disable-line max-len
}
