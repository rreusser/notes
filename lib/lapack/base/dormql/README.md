...
-   `dormql()` corresponds to the [LAPACK][lapack] level routine [`dormql`][lapack-dormql].
...
[lapack-dormql]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dormql.html
