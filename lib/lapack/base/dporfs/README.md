...
-   `dporfs()` corresponds to the [LAPACK][lapack] level routine [`dporfs`][lapack-dporfs].
...
[lapack-dporfs]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dporfs.html
