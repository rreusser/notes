...
#### zlapmt( forwrd, M, N, X, LDX, k, strideK )
...
#### zlapmt.ndarray( forwrd, M, N, X, strideX1, strideX2, offsetX, k, strideK, offsetK )
...
-   `zlapmt()` corresponds to the [LAPACK][lapack] level routine [`zlapmt`][lapack-zlapmt].
...
[lapack-zlapmt]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zlapmt.html
