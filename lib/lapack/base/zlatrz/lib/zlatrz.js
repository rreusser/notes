...
/**
* Factors a complex upper trapezoidal matrix as `( R  0 ) * Z` by means of unitary transformations.
*
...
* @param {PositiveInteger} LDA - leading dimension of `A` (in complex elements)
...
*/
function zlatrz( order, M, N, l, A, LDA, TAU, strideTAU, work, strideWork ) {
	var sa1;
	var sa2;
	...
	return base( M, N, l, A, sa1, sa2, 0, TAU, strideTAU, 0, work, strideWork, 0 );
}
