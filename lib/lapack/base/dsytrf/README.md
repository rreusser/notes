...
dsytrf.ndarray( 'upper', N, A, N, 1, 0, IPIV, 1, 0 );
```
...
-   `dsytrf()` corresponds to the [LAPACK][lapack] level routine [`dsytrf`][lapack-dsytrf].
...
[lapack-dsytrf]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dsytrf.html
