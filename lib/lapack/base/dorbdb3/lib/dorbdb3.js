...
/**
* Simultaneously bidiagonalizes the blocks of a tall and skinny matrix `[X11; X21]` with orthonormal columns (variant 3 — `M-P` is the minimum dimension).
*
...
*/
function dorbdb3( order, M, P, Q, X11, LDX11, X21, LDX21, THETA, strideTHETA, PHI, stridePHI, TAUP1, strideTAUP1, TAUP2, strideTAUP2, TAUQ1, strideTAUQ1, WORK, strideWORK ) {
	var sx111;
	var sx112;
	var sx211;
	var sx212;
