...
var zgesvd = require( './../lib/ndarray.js' );
...
test( 'zgesvd: full_1x1', function t() {
	...
	VT = new Complex128Array( 1 );
	A = c128( [ 5.0, 3.0 ] );
	info = zgesvd( 'all', 'all', 1, 1, A, 1, 1, 0, s, 1, 0, U, 1, 1, 0, VT, 1, 1, 0, WORK, 1, 0, 100, RWORK, 1, 0 ); // eslint-disable-line max-len
...
test( 'zgesvd: full_2x2', function t() {
	...
	info = zgesvd( 'all', 'all', 2, 2, A, 1, 2, 0, s, 1, 0, U, 1, 2, 0, VT, 1, 2, 0, WORK, 1, 0, 500, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0, 'info' );
	assertSingularValuesClose( toArray( s ), tc.s, 1e-12, 's' );
});
...
test( 'zgesvd: full_3x3', function t() {
	...
	info = zgesvd( 'all', 'all', 3, 3, A, 1, 3, 0, s, 1, 0, U, 1, 3, 0, VT, 1, 3, 0, WORK, 1, 0, 1000, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0, 'info' );
	assertSingularValuesClose( toArray( s ), tc.s, 1e-12, 's' );
});
...
test( 'zgesvd: economy_4x3 (JOBU=S, JOBVT=S)', function t() {
	...
	info = zgesvd( 'some', 'some', 4, 3, A, 1, 4, 0, s, 1, 0, U, 1, 4, 0, VT, 1, 3, 0, WORK, 1, 0, 2500, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0, 'info' );
	assertSingularValuesClose( toArray( s ), tc.s, 1e-12, 's' );
});
...
test( 'zgesvd: full_3x5 (M < N, JOBU=A, JOBVT=A)', function t() {
	...
	info = zgesvd( 'all', 'all', 3, 5, A, 1, 3, 0, s, 1, 0, U, 1, 3, 0, VT, 1, 5, 0, WORK, 1, 0, 2500, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0, 'info' );
	assertSingularValuesClose( toArray( s ), tc.s, 1e-12, 's' );
});
...
test( 'zgesvd: economy_u_full_vt_5x3 (JOBU=S, JOBVT=A)', function t() {
	...
	info = zgesvd( 'some', 'all', 5, 3, A, 1, 5, 0, s, 1, 0, U, 1, 5, 0, VT, 1, 3, 0, WORK, 1, 0, 2500, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0, 'info' );
	assertSingularValuesClose( toArray( s ), tc.s, 1e-12, 's' );
});
...
test( 'zgesvd: 3x3 reconstruction U*S*VT ~ A', function t() {
	...
	N = 3;
	minmn = 3;
	info = zgesvd( 'all', 'all', M, N, A, 1, M, 0, s, 1, 0, U, 1, M, 0, VT, 1, N, 0, WORK, 1, 0, 1000, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0, 'info' );
	Uv = reinterpret( U, 0 );
...
test( 'zgesvd: 4x3 JOBU=A JOBVT=N (M > N, U only)', function t() {
	...
	tc = economy_4x3;
	info = zgesvd( 'all', 'none', 4, 3, A, 1, 4, 0, s, 1, 0, U, 1, 4, 0, VT, 1, 1, 0, WORK, 1, 0, 2500, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0, 'info' );
	assertSingularValuesClose( toArray( s ), tc.s, 1e-12, 's' );
});
...
test( 'zgesvd: 4x3 JOBU=N JOBVT=A (M > N, VT only)', function t() {
	...
	tc = economy_4x3;
	info = zgesvd( 'none', 'all', 4, 3, A, 1, 4, 0, s, 1, 0, U, 1, 1, 0, VT, 1, 3, 0, WORK, 1, 0, 2500, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0, 'info' );
	assertSingularValuesClose( toArray( s ), tc.s, 1e-12, 's' );
});
...
test( 'zgesvd: 3x5 JOBU=N JOBVT=S (M < N, VT economy only)', function t() {
	...
	info = zgesvd( 'none', 'some', 3, 5, A, 1, 3, 0, s, 1, 0, U, 1, 1, 0, VT, 1, 3, 0, WORK, 1, 0, 2500, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0, 'info' );
	assertSingularValuesClose( toArray( s ), tc.s, 1e-12, 's' );
});
...
test( 'zgesvd: 3x5 JOBU=S JOBVT=N (M < N, U economy only)', function t() {
	...
	info = zgesvd( 'some', 'none', 3, 5, A, 1, 3, 0, s, 1, 0, U, 1, 3, 0, VT, 1, 1, 0, WORK, 1, 0, 2500, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0, 'info' );
	assertSingularValuesClose( toArray( s ), tc.s, 1e-12, 's' );
});
...
test( 'zgesvd: 3x5 JOBU=A JOBVT=N (M < N, full U only)', function t() {
	...
	info = zgesvd( 'all', 'none', 3, 5, A, 1, 3, 0, s, 1, 0, U, 1, 3, 0, VT, 1, 1, 0, WORK, 1, 0, 2500, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0, 'info' );
	assertSingularValuesClose( toArray( s ), tc.s, 1e-12, 's' );
});
...
test( 'zgesvd: 3x5 JOBU=N JOBVT=A (M < N, full VT only)', function t() {
	...
	info = zgesvd( 'none', 'all', 3, 5, A, 1, 3, 0, s, 1, 0, U, 1, 1, 0, VT, 1, 5, 0, WORK, 1, 0, 2500, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0, 'info' );
	assertSingularValuesClose( toArray( s ), tc.s, 1e-12, 's' );
});
...
test( 'zgesvd: 2x2 reconstruction', function t() {
	...
	M = 2;
	N = 2;
	info = zgesvd( 'all', 'all', M, N, A, 1, M, 0, s, 1, 0, U, 1, M, 0, VT, 1, N, 0, WORK, 1, 0, 500, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0, 'info' );
	Uv = reinterpret( U, 0 );
	VTv = reinterpret( VT, 0 );
	maxErr = 0.0;
...
test( 'zgesvd: 4x3 JOBU=A JOBVT=S reconstruction', function t() {
	...
	A = c128( toArray( A_orig_f64 ) );
	minmn = Math.min( M, N );
	info = zgesvd( 'all', 'some', M, N, A, 1, M, 0, s, 1, 0, U, 1, M, 0, VT, 1, minmn, 0, WORK, 1, 0, 2500, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0, 'info' );
	Uv = reinterpret( U, 0 );
	VTv = reinterpret( VT, 0 );
	maxErr = 0.0;
...
test( 'zgesvd: 3x5 JOBU=A JOBVT=A reconstruction (M < N)', function t() {
	...
	A = c128( toArray( A_orig_f64 ) );
	minmn = Math.min( M, N );
	info = zgesvd( 'all', 'all', M, N, A, 1, M, 0, s, 1, 0, U, 1, M, 0, VT, 1, N, 0, WORK, 1, 0, 2500, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0, 'info' );
	Uv = reinterpret( U, 0 );
	VTv = reinterpret( VT, 0 );
	maxErr = 0.0;
...
test( 'zgesvd: 6x3 JOBU=N JOBVT=N (M >= 2N path 1, values only)', function t() {
	...
	infoRef = zgesvd( 'all', 'all', 6, 3, Aref, 1, 6, 0, sRef, 1, 0, Uref, 1, 6, 0, VTref, 1, 3, 0, WORK, 1, 0, 2500, RWORK, 1, 0 ); // eslint-disable-line max-len
...
test( 'zgesvd: 6x3 JOBU=N JOBVT=S (M >= 2N path 1, VT economy)', function t() {
	...
	Uref = new Complex128Array( 36 );
	VTref = new Complex128Array( 9 );
	zgesvd( 'all', 'all', 6, 3, Aref, 1, 6, 0, sRef, 1, 0, Uref, 1, 6, 0, VTref, 1, 3, 0, WORK, 1, 0, 2500, RWORK, 1, 0 ); // eslint-disable-line max-len
	info = zgesvd( 'none', 'some', 6, 3, A, 1, 6, 0, s, 1, 0, U, 1, 1, 0, VT, 1, 3, 0, WORK, 1, 0, 2500, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0, 'info' );
	assertSingularValuesClose( toArray( s ), toArray( sRef ), 1e-12, 's' );
});
...
test( 'zgesvd: 4x3 JOBU=O JOBVT=S (M >= N, overwrite A with U)', function t() {
	...
	info = zgesvd( 'overwrite', 'some', 4, 3, A, 1, 4, 0, s, 1, 0, U, 1, 1, 0, VT, 1, 3, 0, WORK, 1, 0, 2500, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0, 'info' );
	assertSingularValuesClose( toArray( s ), tc.s, 1e-12, 's' );
});
...
test( 'zgesvd: 4x3 JOBU=S JOBVT=O (M >= N, overwrite A with VT)', function t() {
	...
	info = zgesvd( 'some', 'overwrite', 4, 3, A, 1, 4, 0, s, 1, 0, U, 1, 4, 0, VT, 1, 1, 0, WORK, 1, 0, 2500, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0, 'info' );
	assertSingularValuesClose( toArray( s ), tc.s, 1e-12, 's' );
});
...
test( 'zgesvd: 3x5 JOBU=O JOBVT=S (M < N, overwrite A with U)', function t() {
	...
	info = zgesvd( 'overwrite', 'some', 3, 5, A, 1, 3, 0, s, 1, 0, U, 1, 1, 0, VT, 1, 3, 0, WORK, 1, 0, 2500, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0, 'info' );
	assertSingularValuesClose( toArray( s ), tc.s, 1e-12, 's' );
});
...
test( 'zgesvd: 3x5 JOBU=S JOBVT=O (M < N, overwrite A with VT)', function t() {
	...
	info = zgesvd( 'some', 'overwrite', 3, 5, A, 1, 3, 0, s, 1, 0, U, 1, 3, 0, VT, 1, 1, 0, WORK, 1, 0, 2500, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0, 'info' );
	assertSingularValuesClose( toArray( s ), tc.s, 1e-12, 's' );
});
...
test( 'zgesvd: 3x5 JOBU=S JOBVT=S (M < N, economy SVD)', function t() {
	...
	info = zgesvd( 'some', 'some', 3, 5, A, 1, 3, 0, s, 1, 0, U, 1, 3, 0, VT, 1, 3, 0, WORK, 1, 0, 2500, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0, 'info' );
	assertSingularValuesClose( toArray( s ), tc.s, 1e-12, 's' );
});
...
test( 'zgesvd: 3x5 JOBU=A JOBVT=S (M < N, full U, economy VT)', function t() {
	...
	info = zgesvd( 'all', 'some', 3, 5, A, 1, 3, 0, s, 1, 0, U, 1, 3, 0, VT, 1, 3, 0, WORK, 1, 0, 2500, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0, 'info' );
	assertSingularValuesClose( toArray( s ), tc.s, 1e-12, 's' );
});
...
test( 'zgesvd: very small matrix triggers scaling path', function t() {
	...
	info = zgesvd( 'all', 'all', 2, 2, A2, 1, 2, 0, sRef, 1, 0, U, 1, 2, 0, VT, 1, 2, 0, WORK, 1, 0, 2500, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0, 'ref info' );
	info = zgesvd( 'all', 'all', 2, 2, A1, 1, 2, 0, s, 1, 0, U, 1, 2, 0, VT, 1, 2, 0, WORK, 1, 0, 2500, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0, 'info' );
...
test( 'zgesvd: insufficient lwork triggers internal allocation', function t() {
	...
	info = zgesvd( 'all', 'all', 2, 2, A, 1, 2, 0, s, 1, 0, U, 1, 2, 0, VT, 1, 2, 0, WORK, 1, 0, 1, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0, 'info' );
	assertSingularValuesClose( toArray( s ), tc.s, 1e-12, 's' );
});
...
test( 'zgesvd: 5x3 JOBU=S JOBVT=S reconstruction', function t() {
	...
	A = c128( toArray( A_orig_f64 ) );
	minmn = Math.min( M, N );
	info = zgesvd( 'some', 'some', M, N, A, 1, M, 0, s, 1, 0, U, 1, M, 0, VT, 1, minmn, 0, WORK, 1, 0, 2500, RWORK, 1, 0 ); // eslint-disable-line max-len
	assert.equal( info, 0, 'info' );
	Uv = reinterpret( U, 0 );
	VTv = reinterpret( VT, 0 );
	maxErr = 0.0;
