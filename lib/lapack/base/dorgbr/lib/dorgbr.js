...
* @throws {TypeError} second argument must be a valid vector type
...
*/
function dorgbr( order, vect, M, N, K, A, LDA, TAU, strideTAU, WORK, strideWORK ) {
	var sa1;
	var sa2;
	var ot;
	var ow;
	...
	return base( VECT_MAP[ vect ], M, N, K, A, sa1, sa2, 0, TAU, strideTAU, ot, WORK, strideWORK, ow );
}
