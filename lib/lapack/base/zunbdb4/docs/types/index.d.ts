...
/**
* Interface describing `zunbdb4`.
*/
interface Routine {
	/**
	* simultaneously bidiagonalizes the blocks of a tall, skinny complex matrix with orthonormal columns (CSD-prep variant 4)
	*
	...
	*/
	...
	/**
	* simultaneously bidiagonalizes the blocks of a tall, skinny complex matrix with orthonormal columns (CSD-prep variant 4), using alternative indexing semantics.
	*
	* @param M - number of rows
	* @param p - p
	* @param q - q
