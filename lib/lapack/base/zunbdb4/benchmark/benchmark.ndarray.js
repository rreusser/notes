...
/**
* Builds complex orthonormal-column inputs of size `M`-by-`Q` with `P = M/2` and `Q = 3*M/4` (variant 4: `M-Q <= min(P, M-P, Q)`).
*
* @private
	...
	*/
	function benchmark( b ) {
		...
		for ( i = 0; i < b.iterations; i++ ) {
			...
			info = zunbdb4( M, ins.P, ins.Q, X11, 1, ins.LD, 0, X21, 1, ins.LD, 0, ins.THETA, 1, 0, ins.PHI, 1, 0, ins.TAUP1, 1, 0, ins.TAUP2, 1, 0, ins.TAUQ1, 1, 0, ins.PHANTOM, 1, 0, ins.WORK, 1, 0 );
			if ( info !== 0 ) {
