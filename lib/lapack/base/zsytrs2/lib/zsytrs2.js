...
*/
function zsytrs2( uplo, N, nrhs, A, LDA, IPIV, strideIPIV, B, LDB, WORK, strideWORK ) { // eslint-disable-line max-len, max-params
	var oipiv;
	var owork;
	var sa1;
	var sa2;
	...
	return base( uplo, N, nrhs, A, sa1, sa2, 0, IPIV, strideIPIV, oipiv, B, sb1, sb2, 0, WORK, strideWORK, owork ); // eslint-disable-line max-len
}
