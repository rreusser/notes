...
#### dlapmr( forwrd, M, N, X, LDX, k, strideK )
...
#### dlapmr.ndarray( forwrd, M, N, X, strideX1, strideX2, offsetX, k, strideK, offsetK )
...
-   `dlapmr()` corresponds to the [LAPACK][lapack] level routine [`dlapmr`][lapack-dlapmr].
...
[lapack-dlapmr]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dlapmr.html
