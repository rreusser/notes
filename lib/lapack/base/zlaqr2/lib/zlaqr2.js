...
/**
* Performs aggressive early deflation for the complex QR algorithm (non-recursive).
*
...
*/
function zlaqr2( wantt, wantz, N, ktop, kbot, nw, H, LDH, iloz, ihiz, Z, LDZ, ns, nd, SH, strideSH, V, LDV, nhp, T, LDT, nvp, WV, LDWV, WORK, strideWORK, lwork ) {
	var owork;
	var swv1;
	var swv2;
	var osh;
