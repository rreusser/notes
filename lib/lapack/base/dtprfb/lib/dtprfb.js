...
* @throws {RangeError} eleventh argument must be greater than or equal to max(1,M) or max(1,N)
* @throws {RangeError} thirteenth argument must be greater than or equal to max(1,M) or max(1,N)
* @throws {RangeError} fifteenth argument must be greater than or equal to max(1,M) or max(1,N)
* @throws {RangeError} seventeenth argument must be greater than or equal to max(1,M) or max(1,N)
* @throws {RangeError} nineteenth argument must be greater than or equal to max(1,M) or max(1,N)
* @returns {void}
*/
function dtprfb( order, side, trans, direct, storev, M, N, K, l, V, LDV, T, LDT, A, LDA, B, LDB, WORK, LDWORK ) { // eslint-disable-line max-len, max-params
	var swork1;
	var swork2;
	var sv1;
	var sv2;
	...
	return base( side, trans, direct, storev, M, N, K, l, V, sv1, sv2, 0, T, st1, st2, 0, A, sa1, sa2, 0, B, sb1, sb2, 0, WORK, swork1, swork2, 0 ); // eslint-disable-line max-len
}
