...
/**
* Interface describing `dsytrs_rook`.
*/
interface Routine {
	/**
	* Solve A*X=B using factorization from dsytrf_rook (rook pivoting Bunch-Kaufman)
	*
	...
	*/
	...
	/**
	* Solve A*X=B using factorization from dsytrf_rook (rook pivoting Bunch-Kaufman), using alternative indexing semantics.
	*
	* @param uplo - specifies the operation type
	* @param N - number of columns
	* @param nrhs - nrhs
...
* Solve A*X=B using factorization from dsytrf_rook (rook pivoting Bunch-Kaufman)
*/
declare var dsytrs_rook: Routine;
