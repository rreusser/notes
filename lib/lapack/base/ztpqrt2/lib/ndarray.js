...
* @param {NonNegativeInteger} l - number of rows of the upper trapezoidal part of `B`
...
* @param {Complex128Array} B - input/output pentagonal matrix; on exit contains the Householder reflectors
