...
* @returns {*} result
*/
function zlarf( order, side, M, N, v, strideV, tau, offsetTau, C, LDC, WORK, strideWORK ) {
	var sc1;
	var sc2;
	var ov;
	var ow;
	...
	return base( side, M, N, v, strideV, ov, tau, offsetTau, C, sc1, sc2, 0, WORK, strideWORK, ow );
}
