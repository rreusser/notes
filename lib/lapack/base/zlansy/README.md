...
-   `zlansy()` corresponds to the [LAPACK][lapack] level routine [`zlansy`][lapack-zlansy].
...
[lapack-zlansy]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zlansy.html
