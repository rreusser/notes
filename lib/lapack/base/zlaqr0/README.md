...
#### zlaqr0.ndarray( wantt, wantz, N, ilo, ihi, H, strideH1, strideH2, offsetH, w, strideW, offsetW, iloz, ihiz, Z, strideZ1, strideZ2, offsetZ, WORK, strideWORK, offsetWORK, lwork )
...
-   `zlaqr0()` corresponds to the [LAPACK][lapack] level routine [`zlaqr0`][lapack-zlaqr0].
...
[lapack-zlaqr0]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zlaqr0.html
