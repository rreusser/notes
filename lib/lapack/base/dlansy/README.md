...
dlansy.ndarray( '1', 'upper', N, A, N, 1, 0, WORK, 1, 0 );
```
...
-   `dlansy()` corresponds to the [LAPACK][lapack] level routine [`dlansy`][lapack-dlansy].
...
[lapack-dlansy]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dlansy.html
