...
zhegv.ndarray( N, 'compute-vectors', 'upper', N, A, N, 1, 0, B, N, 1, 0, w, 1, 0, WORK, 1, 0, N, RWORK, 1, 0 );
```
...
-   `zhegv()` corresponds to the [LAPACK][lapack] level routine [`zhegv`][lapack-zhegv].
...
[lapack-zhegv]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__zhegv.html
