...
*
* @module @stdlib/lapack/base/zunmlq
*
* @example
...
*
* zunmlq( 'row-major', 'left', 'no-transpose', 2, 2, 2, A, 2, TAU, 1, C, 2, WORK, 1, 8 );
*
* @example
...
*
* zunmlq.ndarray( 'left', 'no-transpose', 2, 2, 2, A, 1, 2, 0, TAU, 1, 0, C, 1, 2, 0, WORK, 1, 0, 8 );
*/
