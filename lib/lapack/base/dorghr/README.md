...
-   `dorghr()` corresponds to the [LAPACK][lapack] level routine [`dorghr`][lapack-dorghr].
...
[lapack-dorghr]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dorghr.html
