...
-   `dstevx()` corresponds to the [LAPACK][lapack] level routine [`dstevx`][lapack-dstevx].
...
[lapack-dstevx]: https://www.netlib.org/lapack/explore-html/d5/d2f/group__dstevx.html
