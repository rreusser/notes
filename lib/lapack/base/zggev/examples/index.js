...
var out = zggev( 'row-major', 'compute', 'compute', N, A, N, B, N, ALPHA, 1, BETA, 1, VL, N, VR, N );
console.log( out );

// Using the ndarray interface:
out = zggev.ndarray( 'compute', 'compute', N, A, N, 1, 0, B, N, 1, 0, ALPHA, 1, 0, BETA, 1, 0, VL, N, 1, 0, VR, N, 1, 0 );
console.log( out );
