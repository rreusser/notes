...
interface Routine {
	...
	*/
	...
	/**
	* Compute a blocked LQ factorization of a real M-by-N matrix A using the compact WY representation of Q., using alternative indexing semantics.
	*
	* @param M - number of rows
	* @param N - number of columns
	* @param mb - mb
