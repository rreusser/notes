program test_dlartv
  ...
  double precision :: X(NMAX), Y(NMAX), C(NMAX), S(NMAX)
  integer :: i
  ...
  ! Test 6: swap rotation (c=0, s=1) — swaps x and y, negates
  X(1) = 1.0d0
  X(2) = 2.0d0
  Y(1) = 3.0d0
  Y(2) = 4.0d0
  ...
  ! Test 7: mixed strides (INCX=1, INCY=3, INCC=2)
  do i = 1, NMAX
    X(i) = 0.0d0
    Y(i) = 0.0d0
    C(i) = 0.0d0
