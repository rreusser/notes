program test_dsytri_rook
  ...
  ipiv = 0
  call dsytf2_rook('U', n, a, lda, ipiv, info)
  a_fact = a
  call dsytri_rook('U', n, a, lda, ipiv, work, info)
  ...
  a(3,1) = 1.0d0; a(3,2) = 3.0d0; a(3,3) = 6.0d0
  ipiv = 0
  call dsytf2_rook('L', n, a, lda, ipiv, info)
  a_fact = a
  call dsytri_rook('L', n, a, lda, ipiv, work, info)
  ...
  call dsytri_rook('U', 0, a, lda, ipiv, work, info)
