program test_zher2
  ...
  ! Test 1: upper triangle, 2x2, alpha=(1,0)
  ...
  y(2) = (2.0d0, 0.0d0)
  alpha = (1.0d0, 0.0d0)
  call zher2('U', 2, alpha, x, 1, y, 1, A, 2)
  call begin_test('upper_basic')
  call print_array('A', A_r, 8)
  call end_test()

  ! Test 2: lower triangle, 2x2, alpha=(1,0)
  ! Same Hermitian matrix stored in lower:
  !   A = [ 2     .  ]
  !       [(1-1i) 3  ]
  A = (0.0d0, 0.0d0)
  A(1) = (2.0d0, 0.0d0)
  ...
  y(2) = (2.0d0, 0.0d0)
  alpha = (1.0d0, 0.0d0)
  call zher2('L', 2, alpha, x, 1, y, 1, A, 2)
  ...
  A(1) = (99.0d0, 88.0d0)
  alpha = (1.0d0, 0.0d0)
  call zher2('U', 0, alpha, x, 1, y, 1, A, 1)
  ...
  ! Test 6: upper, non-unit stride incx=2, incy=2
  A = (0.0d0, 0.0d0)
  A(1) = (2.0d0, 0.0d0)
  A(4) = (1.0d0, 1.0d0)
  A(5) = (3.0d0, 0.0d0)
  ...
  y(5) = (0.0d0, -1.0d0)
  alpha = (1.0d0, 0.0d0)
  call zher2('U', 3, alpha, x, 2, y, 2, A, 3)
  call begin_test('upper_stride')
  call print_array('A', A_r, 18)
  call end_test()

  ! Test 7: lower, non-unit stride incx=2, incy=2
  A = (0.0d0, 0.0d0)
  A(1) = (2.0d0, 0.0d0)
  A(2) = (1.0d0, -1.0d0)
  A(3) = (2.0d0, 1.0d0)
  ...
  y(5) = (0.0d0, -1.0d0)
  alpha = (1.0d0, 0.0d0)
  call zher2('L', 3, alpha, x, 2, y, 2, A, 3)
  call begin_test('lower_stride')
  call print_array('A', A_r, 18)
  call end_test()

  ! Test 8: complex alpha
  A = (0.0d0, 0.0d0)
  A(1) = (1.0d0, 0.0d0)
  A(3) = (0.0d0, 1.0d0)
  A(4) = (2.0d0, 0.0d0)
  ...
  ! Test 9: upper, 3x3, alpha=(1,0) — larger matrix
  A = (0.0d0, 0.0d0)
  A(1) = (1.0d0, 0.0d0)
  A(4) = (2.0d0, 1.0d0)
  A(5) = (3.0d0, 0.0d0)
  ...
  y(3) = (2.0d0, 2.0d0)
  alpha = (1.0d0, 0.0d0)
  call zher2('U', 3, alpha, x, 1, y, 1, A, 3)
  call begin_test('upper_3x3')
  call print_array('A', A_r, 18)
  call end_test()

  ! Test 10: x and y with zeros (tests skip branch)
  A = (0.0d0, 0.0d0)
  A(1) = (1.0d0, 0.0d0)
  A(3) = (2.0d0, 1.0d0)
  A(4) = (3.0d0, 0.0d0)
