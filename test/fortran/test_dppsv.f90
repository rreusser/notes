program test_dppsv
  ...
  call dppsv('U', 3, 1, ap, b, 3, info)
  call begin_test('not_posdef_upper')
  call print_int('info', info)
  call end_test()

  ! Test 5: N=0 quick return
  call dppsv('L', 0, 1, ap, b, 1, info)
