program test_zla_syrpvgrw
  ...
  double precision :: ZLA_SYRPVGRW, RPVGRW
  external :: ZSYTRF
  ...
  WORK = 0.0D+0
  RPVGRW = ZLA_SYRPVGRW('U', N, INFO, A, NMAX, AF, NMAX, IPIV, WORK)

  ! Pack A and AF for printing
  do j = 1, N
    do i = 1, N
      Apk(i + (j-1)*N) = A(i, j)
      AFpk(i + (j-1)*N) = AF(i, j)
  ...
  WORK = 0.0D+0
  RPVGRW = ZLA_SYRPVGRW('L', N, INFO, A, NMAX, AF, NMAX, IPIV, WORK)
  ...
  N = 4
  A = (0.0D+0, 0.0D+0)
  A(1,1) = (0.1D+0, 0.05D+0)
  A(1,2) = (5.0D+0, 3.0D+0)
  A(1,3) = (0.2D+0, 0.1D+0)
  A(1,4) = (0.3D+0, 0.15D+0)
  A(2,2) = (0.1D+0, 0.04D+0)
  A(2,3) = (0.4D+0, 0.2D+0)
  A(2,4) = (0.5D+0, 0.25D+0)
  A(3,3) = (8.0D+0, 1.0D+0)
  A(3,4) = (1.0D+0, 0.5D+0)
  A(4,4) = (7.0D+0, 0.7D+0)
  ...
  A(3,2) = (0.4D+0, 0.2D+0)
  A(3,3) = (8.0D+0, 1.0D+0)
  A(4,1) = (0.3D+0, 0.15D+0)
  A(4,2) = (0.5D+0, 0.25D+0)
  A(4,3) = (1.0D+0, 0.5D+0)
  A(4,4) = (7.0D+0, 0.7D+0)
  ...
  N = 6
  A = (0.0D+0, 0.0D+0)
  A(1,1) = (0.01D+0, 0.005D+0)
  A(1,2) = (9.0D+0, 4.0D+0)
  A(1,3) = (0.1D+0, 0.05D+0)
  A(1,4) = (0.2D+0, 0.1D+0)
  A(1,5) = (0.3D+0, 0.15D+0)
  A(1,6) = (0.4D+0, 0.2D+0)
  A(2,2) = (0.02D+0, 0.01D+0)
  A(2,3) = (0.5D+0, 0.25D+0)
  A(2,4) = (0.6D+0, 0.3D+0)
  A(2,5) = (0.7D+0, 0.35D+0)
  A(2,6) = (0.8D+0, 0.4D+0)
  A(3,3) = (12.0D+0, 1.0D+0)
  A(3,4) = (1.0D+0, 0.5D+0)
  A(3,5) = (0.5D+0, 0.25D+0)
  A(3,6) = (0.2D+0, 0.1D+0)
  A(4,4) = (10.0D+0, 0.8D+0)
  A(4,5) = (2.0D+0, 1.0D+0)
  A(4,6) = (0.3D+0, 0.15D+0)
  A(5,5) = (11.0D+0, 0.9D+0)
  A(5,6) = (1.5D+0, 0.75D+0)
  A(6,6) = (9.0D+0, 0.7D+0)
  ...
  A(5,2) = (0.7D+0, 0.35D+0)
  A(5,3) = (0.5D+0, 0.25D+0)
  A(5,4) = (2.0D+0, 1.0D+0)
  A(5,5) = (11.0D+0, 0.9D+0)
  A(6,1) = (0.4D+0, 0.2D+0)
  A(6,2) = (0.8D+0, 0.4D+0)
  ...
  N = 4
  A = (0.0D+0, 0.0D+0)
  A(1,1) = (0.001D+0, 0.0005D+0)
  A(2,1) = (0.002D+0, 0.001D+0)
  A(2,2) = (10.0D+0, 1.0D+0)
  A(3,1) = (8.0D+0, 4.0D+0)
  A(3,2) = (0.5D+0, 0.25D+0)
  A(3,3) = (12.0D+0, 1.2D+0)
  A(4,1) = (0.003D+0, 0.0015D+0)
  A(4,2) = (0.4D+0, 0.2D+0)
  A(4,3) = (0.6D+0, 0.3D+0)
  A(4,4) = (9.0D+0, 0.9D+0)
  ...
  N = 5
  A = (0.0D+0, 0.0D+0)
  A(1,1) = (0.0001D+0, 0.00005D+0)
  A(2,1) = (0.0002D+0, 0.0001D+0)
  A(2,2) = (0.0003D+0, 0.00015D+0)
  A(3,1) = (7.0D+0, 3.0D+0)
  A(3,2) = (6.0D+0, 2.5D+0)
  A(3,3) = (20.0D+0, 2.0D+0)
  A(4,1) = (0.001D+0, 0.0005D+0)
  A(4,2) = (0.002D+0, 0.001D+0)
  A(4,3) = (0.5D+0, 0.25D+0)
  A(4,4) = (15.0D+0, 1.5D+0)
  A(5,1) = (0.003D+0, 0.0015D+0)
  A(5,2) = (0.004D+0, 0.002D+0)
  A(5,3) = (0.3D+0, 0.15D+0)
  A(5,4) = (1.0D+0, 0.5D+0)
  A(5,5) = (12.0D+0, 1.2D+0)
