program test_dorgqr
  ...
  integer, parameter :: MAXM = 40, MAXN = 35, LWORK = 1024
  ...
  M = 4; N = 3; KK = 3
  call DGEQRF(M, N, A, MAXM, TAU, WORK, LWORK, INFO)
  call DORGQR(M, N, KK, A, MAXM, TAU, WORK, LWORK, INFO)
  ...
  ! ---------------------------------------------------------------
  ! Test 8: 6x4, K=4 (larger non-blocked)
  ! ---------------------------------------------------------------
  A = 0.0d0
  ...
  ! ---------------------------------------------------------------
  ! Use a simple reproducible matrix: A(i,j) = sin(i*7 + j*13)
  A = 0.0d0
  M = 40; N = 35; KK = 35
  do j = 1, N
    do i = 1, M
