program test_dorbdb1
  ...
  call DORBDB1(m, p, q, X11, NMAX, X21, NMAX, THETA, PHI, &
  ...
  call init_orthonormal_columns(X11, X21, p, m - p, max(1, q), NMAX, NMAX, 4)
