program test_zhetrs_rook
  ...
  call ZHETRS_ROOK('U', n, nrhs, A, NMAX, IPIV, B, NMAX, INFO)
  ...
  call print_int_array('ipiv', IPIV, n)
  call print_array('b', B_r, 2*NMAX*nrhs)
  call ZHETRS_ROOK('L', n, nrhs, A, NMAX, IPIV, B, NMAX, INFO)
  call print_int('info', INFO)
  call print_array('x', B_r, 2*NMAX*nrhs)
  call end_test()

  ! Test 3: N=0
  call ZHETRS_ROOK('U', 0, 1, A, NMAX, IPIV, B, NMAX, INFO)
  call begin_test('n0')
  call print_int('info', INFO)
  call end_test()
