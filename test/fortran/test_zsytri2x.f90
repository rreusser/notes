program test_zsytri2x
  ...
  complex*16 :: WORK_2X((NMAX+8)*9)
  double precision :: A_r(2*NMAX*NMAX)
  equivalence (A, A_r)
  integer :: IPIV(NMAX), INFO, n, LWORK_TF, nb

  LWORK_TF = NMAX * 32

  ! Test 1: 4x4 upper symmetric (1x1 pivots), nb=2
  n = 4
  A = (0.0d0, 0.0d0)
  A(1,1) = (4.0d0, 1.0d0)
  ...
  nb = 2
  call ZSYTRI2X('U', n, A, NMAX, IPIV, WORK_2X, nb, INFO)
  call print_int('info', INFO)
  call print_array('a_inv', A_r, 2*NMAX*n)
  call end_test()

  ! Test 2: 4x4 lower symmetric (1x1 pivots), nb=2
  n = 4
  A = (0.0d0, 0.0d0)
  A(1,1) = (4.0d0, 1.0d0)
  ...
  call print_int_array('ipiv', IPIV, n)
  nb = 2
  call ZSYTRI2X('L', n, A, NMAX, IPIV, WORK_2X, nb, INFO)
  call print_int('info', INFO)
  call print_array('a_inv', A_r, 2*NMAX*n)
  call end_test()
  ...
  ! Test 5: 5x5 lower mixed pivots, nb=2
  n = 5
  A = (0.0d0, 0.0d0)
  A(1,1) = (1.0d0, 0.0d0)
  ...
  ! Test 6: 5x5 upper mixed pivots, nb=3
  n = 5
  A = (0.0d0, 0.0d0)
  A(1,1) = (1.0d0, 0.0d0)
  ...
  ! Test 9: 6x6 lower symmetric mixed, nb=4 (larger block)
  n = 6
  A = (0.0d0, 0.0d0)
  A(1,1) = (4.0d0, 1.0d0)
  A(2,1) = (1.0d0, -1.0d0); A(2,2) = (5.0d0, 2.0d0)
  A(3,1) = (0.0d0, 0.0d0);  A(3,2) = (1.0d0, 1.0d0);  A(3,3) = (6.0d0, -1.0d0)
  A(4,1) = (2.0d0, 0.0d0);  A(4,2) = (0.0d0, 0.0d0);  A(4,3) = (2.0d0, 1.0d0);  A(4,4) = (7.0d0, 1.0d0)
  A(5,1) = (0.0d0, 0.0d0);  A(5,2) = (1.0d0, 0.0d0);  A(5,3) = (0.0d0, 0.0d0);  A(5,4) = (1.0d0, -1.0d0); A(5,5) = (8.0d0, 2.0d0)
  A(6,1) = (1.0d0, 0.0d0);  A(6,2) = (0.0d0, 0.0d0);  A(6,3) = (1.0d0, 0.0d0);  A(6,4) = (0.0d0, 0.0d0);  A(6,5) = (1.0d0, 0.0d0); A(6,6) = (9.0d0, -1.0d0)
  call ZSYTRF('L', n, A, NMAX, IPIV, WORK_TF, LWORK_TF, INFO)
  call begin_test('6x6_lower_mixed_nb4')
  call print_int('info_trf', INFO)
  call print_array('a_factored', A_r, 2*NMAX*n)
  call print_int_array('ipiv', IPIV, n)
  nb = 4
